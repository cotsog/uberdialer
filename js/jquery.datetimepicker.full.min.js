...
!function () {
    ...
    e.datetimepicker = {
        ...
        var s, d, u = this, l = 48, f = 57, c = 96, h = 105, m = 17, g = 46, p = 13, y = 27, v = 8, b = 37, D = 38, x = 39, k = 40, T = 9, S = 116, w = 65, O = 67, M = 86, _ = 90, W = 89, F = !1, C = e.isPlainObject(r) || !r ? e.extend(!0, {}, a, r) : e.extend(!0, {}, a), P = 0, A = function (e) {
        ...
        return s = function (a) {
            function i() {
                var e, t = !1;
                return C.startDate ? t = Y.strToDate(C.startDate) : (t = C.value || (a && a.val && a.val() ? a.val() : ""), t ? t = Y.strToDateTime(t) : C.defaultDate && (t = Y.strToDateTime(C.defaultDate), C.defaultTime && (e = Y.strtotime(C.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes())))), t && Y.isValidDate(t) ? j.data("changed", !0) : t = "", t || 0
            }

            var s, d, u, P, A, Y, j = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'), H = e('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'), J = e('<div class="xdsoft_datepicker active"></div>'), z = e('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'), I = e('<div class="xdsoft_calendar"></div>'), N = e('<div class="xdsoft_timepicker active"><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'), L = N.find(".xdsoft_time_box").eq(0), E = e('<div class="xdsoft_time_variant"></div>'), R = e('<button type="button" class="xdsoft_save_selected blue-gradient-button">Save Selected</button>'), B = e('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'), G = e('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'), V = !1, U = 0, q = 0;
            C.id && j.attr("id", C.id), C.style && j.attr("style", C.style), C.weeks && j.addClass("xdsoft_showweeks"), C.rtl && j.addClass("xdsoft_rtl"), j.addClass("xdsoft_" + C.theme), j.addClass(C.className), z.find(".xdsoft_month span").after(B), z.find(".xdsoft_year span").after(G), z.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                ...
                Y && Y.currentTime && Y.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")), e(this).parent().parent().hide(), j.trigger("xchange.xdsoft"), C.onChangeMonth && e.isFunction(C.onChangeMonth) && C.onChangeMonth.call(j, Y.currentTime, j.data("input")), t !== Y.currentTime.getFullYear() && e.isFunction(C.onChangeYear) && C.onChangeYear.call(j, Y.currentTime, j.data("input"))
            }), j.getValue = function () {
                ...
                C = e.extend(!0, {}, C, r), r.allowTimes && e.isArray(r.allowTimes) && r.allowTimes.length && (C.allowTimes = e.extend(!0, [], r.allowTimes)), r.weekends && e.isArray(r.weekends) && r.weekends.length && (C.weekends = e.extend(!0, [], r.weekends)), r.allowDates && e.isArray(r.allowDates) && r.allowDates.length && (C.allowDates = e.extend(!0, [], r.allowDates)), r.allowDateRe && "[object String]" === Object.prototype.toString.call(r.allowDateRe) && (C.allowDateRe = new RegExp(r.allowDateRe)), r.highlightedDates && e.isArray(r.highlightedDates) && r.highlightedDates.length && (e.each(r.highlightedDates, function (a, r) {
                    var i, s = e.map(r.split(","), e.trim), d = new t(n.parseDate(s[0], C.formatDate), s[1], s[2]), u = n.formatDate(d.date, C.formatDate);
                    ...
                    for (; s >= i;)u = new t(i, d, c), l = n.formatDate(i, C.formatDate), i.setDate(i.getDate() + 1), void 0 !== o[l] ? (f = o[l].desc, f && f.length && u.desc && u.desc.length && (o[l].desc = f + "\n" + u.desc)) : o[l] = u
                    ...
                    z.find("." + C.prev).css("visibility", C.prevButton ? "visible" : "hidden"), z.find("." + C.next).css("visibility", C.nextButton ? "visible" : "hidden"), C.mask && (a.off("keydown.xdsoft"), C.mask === !0 && (C.mask = C.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === e.type(C.mask) && (d(C.mask, a.val()) || (a.val(C.mask.replace(/[0-9]/g, "_")), s(a[0], 0)), a.on("keydown.xdsoft", function (t) {
                    var n, r, o = this.value, u = t.which;
                    if (u >= l && f >= u || u >= c && h >= u || u === v || u === g) {
                        for (n = i(this), r = u !== v && u !== g ? String.fromCharCode(u >= c && h >= u ? u - l : u) : "_", u !== v && u !== g || !n || (n -= 1, r = "_"); /[^0-9_]/.test(C.mask.substr(n, 1)) && n < C.mask.length && n > 0;)n += u === v || u === g ? -1 : 1;
                        if (o = o.substr(0, n) + r + o.substr(n + 1), "" === e.trim(o))o = C.mask.replace(/[0-9]/g, "_"); else if (n === C.mask.length)return t.preventDefault(), !1;
                        for (n += u === v || u === g ? 0 : 1; /[^0-9_]/.test(C.mask.substr(n, 1)) && n < C.mask.length && n > 0;)n += u === v || u === g ? -1 : 1;
                        d(C.mask, o) ? (this.value = o, s(this, n)) : "" === e.trim(o) ? this.value = C.mask.replace(/[0-9]/g, "_") : a.trigger("error_input.xdsoft")
                    } else if (-1 !== [w, O, M, _, W].indexOf(u) && F || -1 !== [y, D, k, b, x, S, m, T, p].indexOf(u))return !0;
                    return t.preventDefault(), !1
                }))), C.validateOnBlur && a.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (C.allowBlank && !e.trim(e(this).val()).length)e(this).val(null), j.data("xdsoft_datetime").empty(); else if (n.parseDate(e(this).val(), C.format))j.data("xdsoft_datetime").setCurrentTime(e(this).val()); else {
                        var t = +[e(this).val()[0], e(this).val()[1]].join(""), a = +[e(this).val()[2], e(this).val()[3]].join("");
                        e(this).val(!C.datepicker && C.timepicker && t >= 0 && 24 > t && a >= 0 && 60 > a ? [t, a].map(function (e) {
                            return e > 9 ? e : "0" + e
                        }).join(":") : n.formatDate(Y.now(), C.format)), j.data("xdsoft_datetime").setCurrentTime(e(this).val())
                    }
                ...
                L.xdsoftScroller()
            }), j.append(J).append(N), C.withoutCopyright !== !0 && j.append(H), J.append(z).append(I).append(R), e(C.parentID).append(j), s = function () {
                var t = this;
                t.now = function (e) {
                    var a, n, r = new Date;
                    ...
                    var a, r, o = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : (o = /^(\+|\-)(.*)$/.exec(e), o && (o[2] = n.parseDate(o[2], C.formatDate)), o && o[2] ? (a = o[2].getTime() - 6e4 * o[2].getTimezoneOffset(), r = new Date(t.now(!0).getTime() + parseInt(o[1] + "1", 10) * a)) : r = e ? n.parseDate(e, C.format) : t.now(), t.isValidDate(r) || (r = t.now()), r)
            ...
            }, Y = new s, R.on("touchend click", function (e) {
                ...
                n = new Date(n.getFullYear(), n.getMonth(), n.getDate()), e = Y.strToDate(C.minDate), e = new Date(e.getFullYear(), e.getMonth(), e.getDate()), e > n || (t = Y.strToDate(C.maxDate), t = new Date(t.getFullYear(), t.getMonth(), t.getDate()), n > t || (a.val(Y.str()), a.trigger("change"), j.trigger("close.xdsoft")))
            }), z.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                var t = e(this), a = 0, n = !1;
                !function r(e) {
                    t.hasClass(C.next) ? Y.nextMonth() : t.hasClass(C.prev) && Y.prevMonth(), C.monthChangeSpinner && (n || (a = setTimeout(r, e || 100)))
                ...
                return C.scrollMonth ? (e.deltaY < 0 ? Y.nextMonth() : Y.prevMonth(), !1) : !0
            }), a.on("mousewheel.xdsoft", function (e) {
                return C.scrollInput ? !C.datepicker && C.timepicker ? (P = E.find(".xdsoft_current").length ? E.find(".xdsoft_current").eq(0).index() : 0, P + e.deltaY >= 0 && P + e.deltaY < E.children().length && (P += e.deltaY), E.children().eq(P).length && E.children().eq(P).trigger("mousedown"), !1) : C.datepicker && !C.timepicker ? (J.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), a.val && a.val(Y.str()), j.trigger("changedatetime.xdsoft"), !1) : void 0 : !0
            }), j.on("changedatetime.xdsoft", function (t) {
                if (C.onChangeDateTime && e.isFunction(C.onChangeDateTime)) {
                    var a = j.data("input");
                    C.onChangeDateTime.call(j, Y.currentTime, a, t), delete C.value, a.trigger("change")
                }
            }).on("generate.xdsoft", function () {
                C.onGenerate && e.isFunction(C.onGenerate) && C.onGenerate.call(j, Y.currentTime, j.data("input")), V && (j.trigger("afterOpen.xdsoft"), V = !1)
            }).on("click.xdsoft", function (e) {
                e.stopPropagation()
            }), P = 0, A = function () {
                var t, a = j.data("input").offset(), n = j.data("input")[0], r = a.top + n.offsetHeight - 1, o = a.left, i = "absolute";
                if (document.documentElement.clientWidth - a.left < J.parent().outerWidth(!0)) {
                    var s = J.parent().outerWidth(!0) - n.offsetWidth;
                    o -= s
                }
                "rtl" == j.data("input").parent().css("direction") && (o -= j.outerWidth() - j.data("input").outerWidth()), C.fixed ? (r -= e(window).scrollTop(), o -= e(window).scrollLeft(), i = "fixed") : (r + n.offsetHeight > e(window).height() + e(window).scrollTop() && (r = a.top - n.offsetHeight + 1), 0 > r && (r = 0), o + n.offsetWidth > e(window).width() && (o = e(window).width() - n.offsetWidth)), t = j[0];
                ...
                var a = !0;
                C.onShow && e.isFunction(C.onShow) && (a = C.onShow.call(j, Y.currentTime, j.data("input"), t)), a !== !1 && (j.show(), A(), e(window).off("resize.xdsoft", A).on("resize.xdsoft", A), C.closeOnWithoutClick && e([document.body, window]).on("touchstart mousedown.xdsoft", function n() {
                    j.trigger("close.xdsoft"), e([document.body, window]).off("touchstart mousedown.xdsoft", n)
                }))
            }).on("close.xdsoft", function (t) {
                var a = !0;
                z.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), C.onClose && e.isFunction(C.onClose) && (a = C.onClose.call(j, Y.currentTime, j.data("input"), t)), a === !1 || C.opened || C.inline || j.hide(), t.stopPropagation()
            }).on("toggle.xdsoft", function () {
                j.trigger(j.is(":visible") ? "close.xdsoft" : "open.xdsoft")
            }).data("input", a), U = 0, q = 0, j.data("xdsoft_datetime", Y), j.setOptions(C), Y.setCurrentTime(i()), a.data("xdsoft_datetimepicker", j).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
                a.is(":disabled") || a.data("xdsoft_datetimepicker").is(":visible") && C.closeOnInputClick || (clearTimeout(U), U = setTimeout(function () {
                    a.is(":disabled") || (V = !0, Y.setCurrentTime(i()), j.trigger("open.xdsoft"))
                }, 100))
            }).on("keydown.xdsoft", function (t) {
                var a, n = (this.value, t.which);
                return -1 !== [p].indexOf(n) && C.enterLikeTab ? (a = e("input:visible,textarea:visible,button:visible,a:visible"), j.trigger("close.xdsoft"), a.eq(a.index(this) + 1).focus(), !1) : -1 !== [T].indexOf(n) ? (j.trigger("close.xdsoft"), !0) : void 0
            })
        }, d = function (t) {
            ...
            if (a) {
                if ("string" === e.type(r))switch (r) {
                    ...
                    case"destroy":
                        ...
                        break;
                    case"reset":
                        this.value = this.defaultValue, this.value && a.data("xdsoft_datetime").isValidDate(n.parseDate(this.value, C.format)) || a.data("changed", !1), a.data("xdsoft_datetime").setCurrentTime(this.value);
                        break;
                    case"validate":
            ...
            "string" !== e.type(r) && (!C.lazyInit || C.open || C.inline ? s(e(this)) : A(e(this)))
        }), u
