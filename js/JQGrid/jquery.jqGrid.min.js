...
!function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        version: "4.8.2", htmlDecode: function (a) {
            ...
            var
                a = $("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"), b = a.appendTo("body").find("td").width();
            ...
            if (a) {
                ...
                if (b.grid) {
                    ...
                    var
                        e = $.jgrid.jqID(b.id);
                    $(d).removeClass("ui-jqgrid-btable").insertBefore("#gbox_" + e), 1 === $(b.p.pager).parents("#gbox_" + e).length && $(b.p.pager).insertBefore("#gbox_" + e), $.jgrid.clearBeforeUnload(a), $("#gbox_" + e).remove(), $(d).attr({id: c.id}), $("#alertmod_" + $.jgrid.jqID(a)).remove()
                }
            }
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                $(this).empty().attr("tabindex", "0"), this.p = c, this.p.useProp = !!$.fn.prop;
                var
                    f, g;
                ...
                var
                    h = $("<div class='ui-jqgrid-view' role='grid'></div>"), i = $.jgrid.msie;
                d.p.direction = $.trim(d.p.direction.toLowerCase()), d.p._ald = !1, -1 === $.inArray(d.p.direction, ["ltr", "rtl"]) && (d.p.direction = "ltr"), g = d.p.direction, $(h).insertBefore(this), $(this).removeClass("scroll").appendTo(h);
                var
                    j = $("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");
                $(j).attr({
                    id: "gbox_" + this.id,
                    dir: g
                }).insertBefore(h), $(h).attr("id", "gview_" + this.id).appendTo(j),$('body').addClass("body_loading"), $("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(h), $("<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(h), $(this).attr({
                    cellspacing: "0",
                    cellpadding: "0",
                    border: "0",
                    role: "presentation",
                ...
                var
                    k, l = ["shiftKey", "altKey", "ctrlKey"], m = function (a, b) {
                        return a = parseInt(a, 10), isNaN(a) ? b || 0 : a
                    }, n = function (a, b, c, f, g, h) {
                        var
                        ...
                        if (void
                            ...
                            var
                                i = {rowId: a, colModel: h, gid: d.p.id, pos: c};
                            g = $.isFunction(h.formatter) ? h.formatter.call(d, b, i, e, f) : $.fmatter ? $.fn.fmatter.call(d, h.formatter, b, i, e, f) : o(b)
                        } else
                            g = o(b);
                        return g
                        ...
                        var
                            g, h;
                        return g = p(a, b, c, e, "add"), h = n(c, d, g, e, a, f), '<td role="gridcell" ' + h + ">" + g + "</td>"
                    }, r = function (a, b, c, e) {
                        var
                            f = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" class="cbox css-checkbox" name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>" + '<label class="css-label radGroup1 cst-export-lbl clr" for="jqg_' + d.p.id + "_" + a + '" />', g = n(b, c, "", null, a, !0);
                        return '<td role="gridcell" ' + g + ">" + f + "</td>"
                    }, s = function (a, b, c, d) {
                        var
                            e = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b, f = n(a, b, e, null, b, !0);
                        ...
                        var
                            a, b, c, e, f, g, h, i, j, k, l, m = d.p, n = m.data, o = n.length, p = m.localReader, q = m.colModel, r = p.cell, s = (m.multiselect === !0 ? 1 : 0) + (m.subGrid === !0 ? 1 : 0) + (m.rownumbers === !0 ? 1 : 0), v = m.scroll ? $.jgrid.randId() : 1;
                        if ("local" === m.datatype && p.repeatitems === !0)for (j = u(s), k = t("local"), e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
                        ...
                        var
                            h, i = "-1", j = "", k = b ? "display:none;" : "", l = "ui-widget-content jqgrow ui-row-" + d.p.direction + (c ? " " + c : "") + (g ? " ui-state-highlight" : ""), m = $(d).triggerHandler("jqGridRowAttr", [e, f, a]);
                        if ("object" != typeof
                                m && (m = $.isFunction(d.p.rowattr) ? d.p.rowattr.call(d, e, f, a) : "string" == typeof
                                d.p.rowattr && null != $.jgrid.rowattr && $.isFunction($.jgrid.rowattr[d.p.rowattr]) ? $.jgrid.rowattr[d.p.rowattr].call(d, e, f, a) : {}), !$.isEmptyObject(m)) {
                            m.hasOwnProperty("id") && (a = m.id, delete
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (v.call(d, !1, !0), b = 1);
                            var
                                k, l, n, o, p, w, x, z, A, B, C = $(d), D = 0, E = d.p.multiselect === !0 ? 1 : 0, F = 0, G = d.p.rownumbers === !0 ? 1 : 0, H = [], I = {}, J = [], K = d.p.altRows === !0 ? d.p.altclass : "";
                            d.p.subGrid === !0 && (F = 1, o = $.jgrid.getMethod("addSubGridCell")), i.repeatitems || (H = t(j)), p = d.p.keyName === !1 ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName, w = -1 === String(p).indexOf("[") ? H.length ? function (a, b) {
                                return $(p, a).text() || b
                            } : function (a, b) {
                                return $(i.cell, a).eq(p).text() || b
                            } : function (a, b) {
                                return a.getAttribute(p.replace(/[\[\]]/g, "")) || b
                            }, d.p.userData = {}, d.p.page = m($.jgrid.getXmlData(a, i.page), d.p.page), d.p.lastpage = m($.jgrid.getXmlData(a, i.total), 1), d.p.records = m($.jgrid.getXmlData(a, i.records)), $.isFunction(i.userdata) ? d.p.userData = i.userdata.call(d, a) || {} : $.jgrid.getXmlData(a, i.userdata, !0).each(function () {
                            ...
                            var
                                M, N = L.length, O = 0, P = [], Q = parseInt(d.p.rowNum, 10), R = d.p.scroll ? $.jgrid.randId() : 1;
                            if (N > 0 && d.p.page <= 0 && (d.p.page = 1), L && N) {
                                e && (Q *= e + 1);
                                var
                                    S, T = $.isFunction(d.p.afterInsertRow), U = !1;
                                for (d.p.grouping && (U = d.p.groupingView.groupCollapse === !0, S = $.jgrid.getMethod("groupingPrepare")); N > O;) {
                                    z = L[O], A = w(z, R + O), A = d.p.idPrefix + A, M = 0 === b ? 0 : b + 1, B = (M + O) % 2 === 1 ? K : "";
                                    var
                                        V = J.length;
                                    if (J.push(""), G && J.push(s(0, O, d.p.page, d.p.rowNum)), E && J.push(r(A, G, O, !1)), F && J.push(o.call(C, E + G, O + b)), i.repeatitems) {
                                        x || (x = u(E + F + G));
                                        var
                                            W = $.jgrid.getXmlData(z, i.cell, !0);
                                        $.each(x, function (a) {
                                            var
                                                c = W[this];
                                            return c ? (n = c.textContent || c.text, I[d.p.colModel[a + E + F + G].name] = n, void
                                                J.push(q(A, n, a + E + F + G, O + b, z, I))) : !1
                                        })
                                    } else
                                        for (k = 0; k < H.length; k++)n = $.jgrid.getXmlData(z, H[k]), I[d.p.colModel[k + E + F + G].name] = n, J.push(q(A, n, k + E + F + G, O + b, z, I));
                                    if (J[V] = y(A, U, B, I, z, !1), J.push("</tr>"), d.p.grouping && (P.push(J), d.p.groupingView._locgr || S.call(C, I, O), J = []), (g || d.p.treeGrid === !0 && !d.p._ald) && (I[h] = $.jgrid.stripPref(d.p.idPrefix, A), d.p.data.push(I), d.p._index[I[h]] = d.p.data.length - 1), d.p.gridview === !1 && ($("tbody:first", d.grid.bDiv).append(J.join("")), C.triggerHandler("jqGridAfterInsertRow", [A, I, z]), T && d.p.afterInsertRow.call(d, A, I, z), J = []), I = {}, D++, O++, D === Q)break
                                }
                            }
                            if (d.p.gridview === !0 && (l = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (C.jqGrid("groupingRender", P, d.p.colModel.length, d.p.page, Q), P = null) : d.p.treeGrid === !0 && l > 0 ? $(d.rows[l]).after(J.join("")) : (d.firstElementChild ? d.firstElementChild.innerHTML += J.join("") : $("#" + $.jgrid.jqID(d.p.id) + " tbody:first").append(J.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0)try {
                                C.jqGrid("addSubGrid", E + G)
                            } catch (X) {
                            }
                            if (d.p.totaltime = new
                                    Date - f, D > 0 && 0 === d.p.records && (d.p.records = N), J = null, d.p.treeGrid === !0)try {
                                C.jqGrid("setTreeNode", l + 1, D + l + 1)
                            } catch (Y) {
                            }
                            if (d.p.reccount = D, d.p.treeANode = -1, d.p.userDataOnFooter && C.jqGrid("footerData", "set", d.p.userData, !0), g && (d.p.records = N, d.p.lastpage = Math.ceil(N / Q)), c || d.updatepager(!1, !0), g) {
                                for (; N > D;) {
                                    if (z = L[D], A = w(z, D + R), A = d.p.idPrefix + A, i.repeatitems) {
                                        x || (x = u(E + F + G));
                                        var
                                            Z = $.jgrid.getXmlData(z, i.cell, !0);
                                        $.each(x, function (a) {
                                            var
                                                b = Z[this];
                                            return b ? (n = b.textContent || b.text, void(I[d.p.colModel[a + E + F + G].name] = n)) : !1
                                        })
                                    } else
                                        for (k = 0; k < H.length; k++)n = $.jgrid.getXmlData(z, H[k]), I[d.p.colModel[k + E + F + G].name] = n;
                                    I[h] = $.jgrid.stripPref(d.p.idPrefix, A), d.p.grouping && S.call(C, I, D), d.p.data.push(I), d.p._index[I[h]] = d.p.data.length - 1, I = {}, D++
                                }
                        ...
                        if (a) {
                            ...
                            var
                                k, l, n, o, p, w, x, z, A, B, C, D, E = $(d), F = 0, G = [], H = d.p.multiselect ? 1 : 0, I = d.p.subGrid === !0 ? 1 : 0, J = d.p.rownumbers === !0 ? 1 : 0, K = u(H + I + J), L = t(h), M = {}, N = [], O = d.p.altRows === !0 ? d.p.altclass : "";
                            d.p.page = m($.jgrid.getAccessor(a, g.page), d.p.page), d.p.lastpage = m($.jgrid.getAccessor(a, g.total), 1), d.p.records = m($.jgrid.getAccessor(a, g.records)), d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, I && (p = $.jgrid.getMethod("addSubGridCell")), A = d.p.keyName === !1 ? $.isFunction(g.id) ? g.id.call(d, a) : g.id : d.p.keyName, z = $.jgrid.getAccessor(a, g.root), null == z && $.isArray(a) && (z = a), z || (z = []), x = z.length, l = 0, x > 0 && d.p.page <= 0 && (d.p.page = 1);
                            var
                                P, Q, R = parseInt(d.p.rowNum, 10), S = d.p.scroll ? $.jgrid.randId() : 1, T = !1;
                            e && (R *= e + 1), "local" !== d.p.datatype || d.p.deselectAfterSort || (T = !0);
                            var
                                U, V = $.isFunction(d.p.afterInsertRow), W = [], X = !1;
                            for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0, U = $.jgrid.getMethod("groupingPrepare")); x > l;) {
                                if (o = z[l], C = $.jgrid.getAccessor(o, A), void
                                        0 === C && ("number" == typeof
                                        A && null != d.p.colModel[A + H + I + J] && (C = $.jgrid.getAccessor(o, d.p.colModel[A + H + I + J].name)), void
                                        0 === C && (C = S + l, 0 === G.length && g.cell))) {
                                    var
                                        Y = $.jgrid.getAccessor(o, g.cell) || o;
                                    C = null != Y && void
                                        0 !== Y[A] ? Y[A] : C, Y = null
                                }
                                C = d.p.idPrefix + C, P = 1 === b ? 0 : b, D = (P + l) % 2 === 1 ? O : "", T && (Q = d.p.multiselect ? -1 !== $.inArray(C, d.p.selarrrow) : C === d.p.selrow);
                                var
                                    Z = N.length;
                                for (N.push(""), J && N.push(s(0, l, d.p.page, d.p.rowNum)), H && N.push(r(C, J, l, Q)), I && N.push(p.call(E, H + J, l + b)), w = L, g.repeatitems && (g.cell && (o = $.jgrid.getAccessor(o, g.cell) || o), $.isArray(o) && (w = K)), n = 0; n < w.length; n++)k = $.jgrid.getAccessor(o, w[n]), M[d.p.colModel[n + H + I + J].name] = k, N.push(q(C, k, n + H + I + J, l + b, o, M));
                                if (N[Z] = y(C, X, D, M, o, Q), N.push("</tr>"), d.p.grouping && (W.push(N), d.p.groupingView._locgr || U.call(E, M, l), N = []), (j || d.p.treeGrid === !0 && !d.p._ald) && (M[i] = $.jgrid.stripPref(d.p.idPrefix, C), d.p.data.push(M), d.p._index[M[i]] = d.p.data.length - 1), d.p.gridview === !1 && ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first").append(N.join("")), E.triggerHandler("jqGridAfterInsertRow", [C, M, o]), V && d.p.afterInsertRow.call(d, C, M, o), N = []), M = {}, F++, l++, F === R)break
                            }
                            if (d.p.gridview === !0 && (B = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (E.jqGrid("groupingRender", W, d.p.colModel.length, d.p.page, R), W = null) : d.p.treeGrid === !0 && B > 0 ? $(d.rows[B]).after(N.join("")) : (d.firstElementChild ? d.firstElementChild.innerHTML += N.join("") : $("#" + $.jgrid.jqID(d.p.id) + " tbody:first").append(N.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0)try {
                                E.jqGrid("addSubGrid", H + J)
                            } catch (_) {
                            }
                            if (d.p.totaltime = new
                                    Date - f, F > 0 && 0 === d.p.records && (d.p.records = x), N = null, d.p.treeGrid === !0)try {
                                E.jqGrid("setTreeNode", B + 1, F + B + 1)
                            } catch (ab) {
                            }
                            if (d.p.reccount = F, d.p.treeANode = -1, d.p.userDataOnFooter && E.jqGrid("footerData", "set", d.p.userData, !0), j && (d.p.records = x, d.p.lastpage = Math.ceil(x / R)), c || d.updatepager(!1, !0), j) {
                                for (; x > F && z[F];) {
                                    if (o = z[F], C = $.jgrid.getAccessor(o, A), void
                                            0 === C && ("number" == typeof
                                            A && null != d.p.colModel[A + H + I + J] && (C = $.jgrid.getAccessor(o, d.p.colModel[A + H + I + J].name)), void
                                            0 === C && (C = S + F, 0 === G.length && g.cell))) {
                                        var
                                            bb = $.jgrid.getAccessor(o, g.cell) || o;
                                        C = null != bb && void
                                            0 !== bb[A] ? bb[A] : C, bb = null
                                    }
                                    if (o) {
                                        for (C = d.p.idPrefix + C, w = L, g.repeatitems && (g.cell && (o = $.jgrid.getAccessor(o, g.cell) || o), $.isArray(o) && (w = K)), n = 0; n < w.length; n++)M[d.p.colModel[n + H + I + J].name] = $.jgrid.getAccessor(o, w[n]);
                                        M[i] = $.jgrid.stripPref(d.p.idPrefix, C), d.p.grouping && U.call(E, M, F), d.p.data.push(M), d.p._index[M[i]] = d.p.data.length - 1, M = {}
                                    }
                                    F++
                                }
                                d.p.grouping && (d.p.groupingView._locgr = !0, E.jqGrid("groupingRender", W, d.p.colModel.length, d.p.page, R), W = null)
                            }
                        }
                    }, B = function () {
                        function
                        ...
                        if ($.isArray(d.p.data)) {
                            var
                                m, n, o = d.p.grouping ? d.p.groupingView : !1;
                            if ($.each(d.p.colModel, function () {
                                    if (c = this.sorttype || "text", "date" === c || "datetime" === c ? (this.formatter && "string" == typeof
                                    ...
                                    if (d.p.multiSort) {
                                        ...
                                        i || this.index !== d.p.sortname && this.name !== d.p.sortname || (g = this.name, i = !0)
                                }), d.p.treeGrid && d.p._sort)return void
                            ...
                            var
                                t = q.select(), u = parseInt(d.p.rowNum, 10), v = t.length, w = parseInt(d.p.page, 10), x = Math.ceil(v / u), y = {};
                            if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                                d.p.groupingView.groups = [];
                                var
                                    z, A, B, C = $.jgrid.getMethod("groupingPrepare");
                                if (d.p.footerrow && d.p.userDataOnFooter) {
                                    for (A
                                        in
                                        d.p.userData)d.p.userData.hasOwnProperty(A) && (d.p.userData[A] = 0);
                                    B = !0
                                }
                                for (z = 0; v > z; z++) {
                                    if (B)for (A
                                        in
                                        d.p.userData)d.p.userData.hasOwnProperty(A) && (d.p.userData[A] += parseFloat(t[z][A] || 0));
                                    C.call($(d), t[z], z, u)
                                }
                            }
                            return t = d.p.treeGrid && d.p.search ? $(d).jqGrid("searchTree", t) : t.slice((w - 1) * u, w * u), q = null, j = null, y[d.p.localReader.total] = x, y[d.p.localReader.page] = w, y[d.p.localReader.records] = v, y[d.p.localReader.root] = t, y[d.p.localReader.userdata] = d.p.userData, t = null, y
                        }
                    }, C = function (a, b) {
                        var
                            c, e, f, g, h, i, j, k, l = "", n = d.p.pager ? $.jgrid.jqID(d.p.pager.substr(1)) : "", o = n ? "_" + n : "", p = d.p.toppager ? "_" + d.p.toppager.substr(1) : "";
                        if (f = parseInt(d.p.page, 10) - 1, 0 > f && (f = 0), f *= parseInt(d.p.rowNum, 10), h = f + d.p.reccount, d.p.scroll) {
                            var
                                q = $("tbody:first > tr:gt(0)", d.grid.bDiv);
                            f = h - q.length, d.p.reccount = q.length;
                            var
                                r = q.outerHeight() || d.grid.prevRowHeight;
                            if (r) {
                                var
                                    s = f * r, t = parseInt(d.p.records, 10) * r;
                                $(">div:first", d.grid.bDiv).css({height: t}).children("div:first").css({
                                    height: s,
                                    display: s ? "" : "none"
                                }), 0 === d.grid.bDiv.scrollTop && d.p.page > 1 && (d.grid.bDiv.scrollTop = d.p.rowNum * (d.p.page - 1) * r)
                            }
                            d.grid.bDiv.scrollLeft = d.grid.hDiv.scrollLeft
                        }
                        if (l = d.p.pager || "", l += d.p.toppager ? l ? "," + d.p.toppager : d.p.toppager : "") {
                            if (j = $.jgrid.getRegional(d, "formatter.integer"), c = m(d.p.page), e = m(d.p.lastpage), $(".selbox", l)[this.p.useProp ? "prop" : "attr"]("disabled", !1), d.p.pginput === !0 && ($("#input" + o).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input ui-corner-all' type='button' size='2' maxlength='7' value='0' role='textbox' readonly/>", "<span id='sp_1_" + $.jgrid.jqID(n) + "'></span>")), d.p.toppager && $("#input_t" + p).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(n) + "_toppager'></span>")), $(".ui-pg-input", l).val(d.p.page), k = d.p.toppager ? "#sp_1" + o + ",#sp_1" + p : "#sp_1" + o, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)), d.p.viewrecords)if (0 === d.p.reccount)$(".ui-paging-info", l).html($.jgrid.getRegional(d, "defaults.emptyrecords", d.p.emptyrecords)); else {
                                ...
                                var
                                    u = $.jgrid.getRegional(d, "defaults.recordtext", d.p.recordtext);
                                $(".ui-paging-info", l).html($.jgrid.template(u, g, h, i))
                            }
                        ...
                        if (!d.grid.hDiv.loading) {
                            ...
                            if (a = a || 1, a > 1 ? null !== g.npage ? (f[g.npage] = a, j = a - 1, a = 1) : i = function (b) {
                                    d.p.page++, d.grid.hDiv.loading = !1, h && d.p.loadComplete.call(d, b), F(a - 1)
                                } : null !== g.npage && delete
                            ...
                            switch (b = d.p.datatype.toLowerCase()) {
                                    ...
                                    $.ajax($.extend({
                                        ...
                                        success: function (c, f, g) {
                                            return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void
                                                E() : ("xml" === b ? z(c, o, a > 1, j) : A(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && E()))
                                        },
                                        error: function (b, c, e) {
                                            $.isFunction(d.p.loadError) && d.p.loadError.call(d, b, c, e), 1 === a && E(), b = null
                                        },
                                ...
                                case"xmlstring":
                                    D(), c = "string" != typeof
                                        d.p.datastr ? d.p.datastr : $.parseXML(d.p.datastr), z(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, E();
                                    break;
                                case"jsonstring":
                                    D(), c = "string" == typeof
                                        d.p.datastr ? $.jgrid.parse(d.p.datastr) : d.p.datastr, A(c), $(d).triggerHandler("jqGridLoadComplete", [c]), h && d.p.loadComplete.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), d.p.datatype = "local", d.p.datastr = null, E();
                                    break;
                                case"local":
                                case"clientside":
                                    D(), d.p.datatype = "local", d.p._ald = !0;
                                    var
                                        q = B();
                                    A(q, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [q]), i && i.call(d, q), $(d).triggerHandler("jqGridAfterLoadComplete", [q]), e && d.grid.populateVisible(), E(), d.p._ald = !1
                            }
                            d.p._sort = !1
                        }
                    }, G = function (a) {
                        ...
                        var
                            c, e, f, h, i, j, k, l = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>", n = "", o = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", p = "", q = function (a) {
                                var
                                    b;
                                return $.isFunction(d.p.onPaging) && (b = d.p.onPaging.call(d, a)), "stop" === b ? !1 : (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], G(!1)), d.p.savedRow = [], !0)
                            };
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", h = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + h + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                            p = '<td dir="' + g + '">', p += '<select class="ui-pg-selbox ui-widget-content ui-corner-all" role="listbox" title="' + ($.jgrid.getRegional(d, "defaults.pgrecs", d.p.pgrecs) || "") + '">';
                            var
                                r;
                            for (k = 0; k < d.p.rowList.length; k++)r = d.p.rowList[k].toString().split(":"), 1 === r.length && (r[1] = r[0]), p += '<option role="option" value="' + r[0] + '"' + (m(d.p.rowNum, 0) === m(r[0], 0) ? ' selected="selected"' : "") + ">" + r[1] + "</option>";
                            p += "</select></td>"
                        }
                        if ("rtl" === g && (o += p), d.p.pginput === !0 && (n = "<td id='input" + b + "' dir='" + g + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                            var
                                s = ["first" + b, "prev" + b, "next" + b, "last" + b];
                            "rtl" === g && s.reverse(), o += "<td id='" + s[0] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "") + "'><span class='ui-icon ui-icon-seek-first'>First</span></td>", o += "<td id='" + s[1] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "") + "'><span class='ui-icon ui-icon-seek-prev'>Previous</span></td>", o += "" !== n ? l + n + l : "", o += "<td id='" + s[2] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "") + "'><span class='ui-icon ui-icon-seek-next'>Next</span></td>", o += "<td id='" + s[3] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || "") + "'><span class='ui-icon ui-icon-seek-end'>Last</span></td>"
                        } else"" !== n && (o += n);
                        "ltr" === g && (o += p), o += "</tr></tbody></table>", d.p.viewrecords === !0 && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + g + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(o), j = $(".ui-jqgrid").css("font-size") || "11px", $(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(o).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== n && (i += 50), $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)), d.p._nvtd = [], d.p._nvtd[0] = Math.floor(i ? (d.p.width - i) / 2 : d.p.width / 3), d.p._nvtd[1] = 0, o = null, $(".ui-pg-selbox", "#" + c).bind("change", function () {
                            return q("records") ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1, d.p.rowNum = this.value, d.p.pager && $(".ui-pg-selbox", d.p.pager).val(this.value), d.p.toppager && $(".ui-pg-selbox", d.p.toppager).val(this.value), F(), !1) : !1
                            ...
                            var
                                a = m(d.p.page, 1), c = m(d.p.lastpage, 1), e = !1, f = !0, g = !0, h = !0, i = !0;
                            return 0 === c || 1 === c ? (f = !1, g = !1, h = !1, i = !1) : c > 1 && a >= 1 ? 1 === a ? (f = !1, g = !1) : a === c && (h = !1, i = !1) : c > 1 && 0 === a && (h = !1, i = !1, a = c - 1), q(this.id.split("_")[0]) ? (this.id === "first" + b && f && (d.p.page = 1, e = !0), this.id === "prev" + b && g && (d.p.page = a - 1, e = !0), this.id === "next" + b && h && (d.p.page = a + 1, e = !0), this.id === "last" + b && i && (d.p.page = c, e = !0), e && F(), !1) : !1
                        })), d.p.pginput === !0 && $("#" + c).on("keypress", "input.ui-pg-input", function (a) {
                            var
                                b = a.charCode || a.keyCode || 0;
                            return 13 === b ? q("user") ? ($(this).val(m($(this).val(), 1)), d.p.page = $(this).val() > 0 ? $(this).val() : d.p.page, F(), !1) : !1 : this
                        })
                    }, I = function (a, b) {
                        var
                            c, e, f = "", g = d.p.colModel, h = !1, i = d.p.frozenColumns ? b : d.grid.headers[a].el, j = "";
                        $("span.ui-grid-ico-sort", i).addClass("ui-state-disabled"), $(i).attr("aria-selected", "false"), g[a].lso ? "asc" === g[a].lso ? (g[a].lso += "-desc", j = "desc") : "desc" === g[a].lso ? (g[a].lso += "-asc", j = "asc") : ("asc-desc" === g[a].lso || "desc-asc" === g[a].lso) && (g[a].lso = "") : g[a].lso = j = g[a].firstsortorder || "asc", j ? ($("span.s-ico", i).show(), $("span.ui-icon-" + j, i).removeClass("ui-state-disabled"), $(i).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", i).hide(), d.p.sortorder = "", $.each(g, function (a) {
                            this.lso && (a > 0 && h && (f += ", "), c = this.lso.split("-"), f += g[a].index || g[a].name, f += " " + c[c.length - 1], h = !0, d.p.sortorder = c[c.length - 1])
                        }), e = f.lastIndexOf(d.p.sortorder), f = f.substring(0, e), d.p.sortname = f
                    }, J = function (a, b, c, e, f) {
                        if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                            if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort)I(b, f); else {
                                if (e) {
                                    if (d.p.lastsort === b && d.p.sortorder === e && !c)return;
                                    d.p.sortorder = e
                                }
                                var
                                    g = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null, h = d.p.frozenColumns ? f : d.grid.headers[b].el;
                                $("span.ui-grid-ico-sort", g).addClass("ui-state-disabled"), $(g).attr("aria-selected", "false"), d.p.frozenColumns && (d.grid.fhDiv.find("span.ui-grid-ico-sort").addClass("ui-state-disabled"), d.grid.fhDiv.find("th").attr("aria-selected", "false")), $("span.ui-icon-" + d.p.sortorder, h).removeClass("ui-state-disabled"), $(h).attr("aria-selected", "true"), d.p.viewsortcols[0] || (d.p.lastsort !== b ? (d.p.frozenColumns && d.grid.fhDiv.find("span.s-ico").hide(), $("span.s-ico", g).hide(), $("span.s-ico", h).show()) : "" === d.p.sortname && $("span.s-ico", h).show()), a = a.substring(5 + d.p.id.length + 1), d.p.sortname = d.p.colModel[b].index || a
                            }
                            ...
                            if ("local" === d.p.datatype ? d.p.deselectAfterSort && $(d).jqGrid("resetSelection") : (d.p.selrow = null, d.p.multiselect && G(!1), d.p.selarrrow = [], d.p.savedRow = []), d.p.scroll) {
                                var
                                    i = d.grid.bDiv.scrollLeft;
                                v.call(d, !0, !1), d.grid.hDiv.scrollLeft = i
                            }
                            d.p.subGrid && "local" === d.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(d.p.id)).each(function () {
                                $(this).trigger("click")
                            }), d.p._sort = !0, F(), d.p.lastsort = b, d.p.sortname !== a && b && (d.p.lastsort = b)
                        }
                    }, K = function () {
                        var
                            a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : m(d.p.cellLayout, 0), i = 0, j = m(d.p.scrollOffset, 0), k = !1, l = 0;
                        $.each(d.p.colModel, function () {
                            ...
                            this.widthOrg = b = m(this.width, 0), this.hidden === !1 && (g += b + h, this.fixed ? l += b + h : i++)
                ...
                for (this.p.id = this.id, -1 === $.inArray(d.p.multikey, l) && (d.p.multikey = !1), d.p.keyName = !1, f = 0; f < d.p.colModel.length; f++)k = "string" == typeof
                    d.p.colModel[f].template ? null != $.jgrid.cmTemplate && "object" == typeof
                    $.jgrid.cmTemplate[d.p.colModel[f].template] ? $.jgrid.cmTemplate[d.p.colModel[f].template] : {} : d.p.colModel[f].template, d.p.colModel[f] = $.extend(!0, {}, d.p.cmTemplate, k || {}, d.p.colModel[f]), d.p.keyName === !1 && d.p.colModel[f].key === !0 && (d.p.keyName = d.p.colModel[f].name);
                ...
                this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox css-checkbox' type='checkbox'/><label class='css-label radGroup1 cst-export-lbl clr' for='cb_" + this.p.id + "'/>"), this.p.colModel.unshift({
                    name: "cb",
                    ...
                    userdata: "userdata",
                    subgrid: {root: "rows", repeatitems: !0, cell: "cell"}
                }, d.p.localReader), d.p.scroll && (d.p.pgbuttons = !1, d.p.pginput = !1, d.p.rowList = []), d.p.data.length && (w(), x());
                var
                    Q, R, S, T, U, V, W, X, Y, Z = "<thead><tr class='ui-jqgrid-labels' role='row'>", _ = "", ab = "", bb = [], cb = [], db = [];
                if (d.p.shrinkToFit === !0 && d.p.forceFit === !0)for (f = d.p.colModel.length - 1; f >= 0; f--)if (!d.p.colModel[f].hidden) {
                    d.p.colModel[f].resizable = !1;
                    break
                }
                if ("horizontal" === d.p.viewsortcols[1] && (_ = " ui-i-asc", ab = " ui-i-desc"), Q = i ? "class='ui-th-div-ie'" : "", Y = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + _ + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>", Y += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ab + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>", d.p.multiSort)for (bb = d.p.sortname.split(","), f = 0; f < bb.length; f++)db = $.trim(bb[f]).split(" "), bb[f] = $.trim(db[0]), cb[f] = db[1] ? $.trim(db[1]) : d.p.sortorder || "asc";
                for (f = 0; f < this.p.colNames.length; f++) {
                    var
                        eb = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[f]) + '"' : "";
                    Z += "<th id='" + d.p.id + "_" + d.p.colModel[f].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + g + "'" + eb + ">", R = d.p.colModel[f].index || d.p.colModel[f].name, Z += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[f].name + "' " + Q + ">" + d.p.colNames[f], d.p.colModel[f].width = d.p.colModel[f].width ? parseInt(d.p.colModel[f].width, 10) : 150, "boolean" != typeof
                        d.p.colModel[f].title && (d.p.colModel[f].title = !0), d.p.colModel[f].lso = "", R === d.p.sortname && (d.p.lastsort = f), d.p.multiSort && (db = $.inArray(R, bb), -1 !== db && (d.p.colModel[f].lso = cb[db])), Z += Y + "</div></th>"
                }
                if (Z += "</tr></thead>", Y = null, $(this).append(Z), $("thead tr:first th", this).hover(function () {
                    ...
                    $("#cb_" + $.jgrid.jqID(d.p.id), this).bind("click", function () {
                        ...
                        }), d.p.selrow = null, fb = !1), $(d).triggerHandler("jqGridSelectAll", [fb ? d.p.selarrrow : gb, fb]), $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, fb ? d.p.selarrrow : gb, fb)
                    })
                }
                if (d.p.autowidth === !0) {
                    var
                        hb = $(j).innerWidth();
                    d.p.width = hb > 0 ? hb : "nw"
                }
                K(), $(j).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"), d.p.scrollPopUp && $(j).append("<div class='loading ui-scroll-popup ui-widget-content' id='scroll_g" + d.p.id + "'></div>"), $(h).css("width", e.width + "px"), Z = $("thead:first", d).get(0);
                var
                    ib = "";
                d.p.footerrow && (ib += "<table role='presentation' style='width:" + d.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + g + "'>");
                var
                    jb = $("tr:first", Z), kb = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
                if (d.p.disableClick = !1, $("th", jb).each(function (a) {
                        S = d.p.colModel[a].width, void
                            0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0), d.p.colModel[a].resizable ? (T = document.createElement("span"), $(T).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + g).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : T = "", $(this).css("width", S + "px").prepend(T), T = null;
                        var
                            b = "";
                        d.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), kb += "<td role='gridcell' style='height:0px;width:" + S + "px;" + b + "'></td>", e.headers[a] = {
                            width: S,
                            el: this
                        }, U = d.p.colModel[a].sortable, "boolean" != typeof
                            U && (d.p.colModel[a].sortable = !0, U = !0);
                        var
                            c = d.p.colModel[a].name;
                        "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), U && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), d.p.colModel[a].lso && $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled"))), d.p.footerrow && (ib += "<td role='gridcell' " + n(a, 0, "", null, "", !1) + ">&#160;</td>")
                    }).mousedown(function (a) {
                        if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                            var
                                b = N(this);
                            return d.p.forceFit === !0 && (d.p.nv = L(b)), e.dragStart(b, a, M(b)), !1
                        }
                    }).click(function (a) {
                        ...
                        if (1 === f.length) {
                            ...
                            if (d.p.frozenColumns) {
                                ...
                                g = N(this);
                            return d.p.viewsortcols[2] || (b = !0, c = f.attr("sort")), null != g && J($("div", this)[0].id, g, b, c, this), !1
                        }
                    }), d.p.sortable && $.fn.sortable)try {
                    $(d).jqGrid("sortableColumns", jb)
                } catch (lb) {
                }
                d.p.footerrow && (ib += "</tr></tbody></table>"), kb += "</tr>", X = document.createElement("tbody"), this.appendChild(X), $(this).addClass("ui-jqgrid-btable").append(kb), kb = null;
                var
                    mb = $("<table class='ui-jqgrid-htable' style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(Z), nb = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1, ob = $("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>");
                Z = null, e.hDiv = document.createElement("div"), $(e.hDiv).css({width: e.width + "px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(ob), $(ob).append(mb), mb = null, nb && $(e.hDiv).hide(), d.p.pager && ("string" == typeof
                    d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(j), nb && $(d.p.pager).hide(), H(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
                    W = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(W).attr("class") && $(W).addClass("ui-state-hover")
                }).bind("mouseout", function (a) {
                    W = $(a.target).closest("tr.jqgrow"), $(W).removeClass("ui-state-hover")
                });
                var
                    pb, qb, rb;
                $(d).before(e.hDiv).click(function (a) {
                    if (V = a.target, W = $(V, d.rows).closest("tr.jqgrow"), 0 === $(W).length || W[0].className.indexOf("ui-state-disabled") > -1 || ($(V, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)return this;
                    var
                        b = $(V).hasClass("cbox"), c = $(d).triggerHandler("jqGridBeforeSelectRow", [W[0].id, a]);
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var
                            e = d.p.beforeSelectRow.call(d, W[0].id, a);
                        (e === !1 || "stop" === e) && (c = !1)
                    }
                    if ("A" !== V.tagName && ("INPUT" !== V.tagName && "TEXTAREA" !== V.tagName && "OPTION" !== V.tagName && "SELECT" !== V.tagName || b)) {
                        if (pb = W[0].id, V = $(V).closest("tr.jqgrow>td"), V.length > 0 && (qb = $.jgrid.getCellIndex(V), rb = $(V).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [pb, qb, rb, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, pb, qb, rb, a)), d.p.cellEdit === !0)if (d.p.multiselect && b && c)$(d).jqGrid("setSelection", pb, !0, a); else if (V.length > 0) {
                            pb = W[0].rowIndex;
                            try {
                                $(d).jqGrid("editCell", pb, qb, !0)
                            } catch (f) {
                            }
                        }
                        if (c)if (d.p.multikey)a[d.p.multikey] ? $(d).jqGrid("setSelection", pb, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + pb).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + pb)[d.p.useProp ? "prop" : "attr"]("checked", b)); else if (d.p.multiselect && d.p.multiboxonly)if (b)$(d).jqGrid("setSelection", pb, !0, a); else {
                            var
                                g = d.p.frozenColumns ? d.p.id + "_frozen" : "";
                            $(d.p.selarrrow).each(function (a, b) {
                                var
                                    c = $(d).jqGrid("getGridRowById", b);
                                c && $(c).removeClass("ui-state-highlight"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", !1), g && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g)).removeClass("ui-state-highlight"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g))[d.p.useProp ? "prop" : "attr"]("checked", !1))
                            }), d.p.selarrrow = [], $(d).jqGrid("setSelection", pb, !0, a)
                        } else
                            $(d).jqGrid("setSelection", pb, !0, a)
                    }
                }).bind("reloadGrid", function (a, b) {
                    if (d.p.treeGrid === !0 && (d.p.datatype = d.p.treedatatype), b && b.current && d.grid.selectionPreserver(d), "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (w(), x())) : d.p.treeGrid || (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], G(!1)), d.p.savedRow = []), d.p.scroll && v.call(d, !0, !1), b && b.page) {
                        var
                            c = b.page;
                    ...
                    return d.grid.prevRowHeight && d.p.scroll ? (delete
                        d.p.lastpage, d.grid.populateVisible()) : d.grid.populate(), d.p.inlineNav === !0 && $(d).jqGrid("showAddEditButtons"), !1
                }).dblclick(function (a) {
                    if (V = a.target, W = $(V, d.rows).closest("tr.jqgrow"), 0 !== $(W).length) {
                        pb = W[0].rowIndex, qb = $.jgrid.getCellIndex(V);
                        var
                            b = $(d).triggerHandler("jqGridDblClickRow", [$(W).attr("id"), pb, qb, a]);
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(W).attr("id"), pb, qb, a), null != b) ? b : void
                            0
                    }
                }).bind("contextmenu", function (a) {
                    if (V = a.target, W = $(V, d.rows).closest("tr.jqgrow"), 0 !== $(W).length) {
                        d.p.multiselect || $(d).jqGrid("setSelection", W[0].id, !0, a), pb = W[0].rowIndex, qb = $.jgrid.getCellIndex(V);
                        var
                            b = $(d).triggerHandler("jqGridRightClickRow", [$(W).attr("id"), pb, qb, a]);
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(W).attr("id"), pb, qb, a), null != b) ? b : void
                            0
                    }
                }), e.bDiv = document.createElement("div"), i && "auto" === String(d.p.height).toLowerCase() && (d.p.height = "100%"), $(e.bDiv).append($('<div style="position:relative;"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                ...
                if ($(e.cDiv).append(sb).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === g ? "-rtl" : "") + " ui-widget-header ui-corner-top ui-helper-clearfix"), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0] && (e.uDiv = document.createElement("div"), "top" === d.p.toolbar[1] ? $(e.uDiv).insertBefore(e.hDiv) : "bottom" === d.p.toolbar[1] && $(e.uDiv).insertAfter(e.hDiv), "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"), $(e.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(e.hDiv), $(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(e.hDiv), nb && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), nb && $(e.uDiv).hide()), d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv), H(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], ob = $("<div class='ui-jqgrid-hbox" + ("rtl" === g ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(ob).width(e.width).insertAfter(e.hDiv), $(ob).append(ib), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = "ui-state-default jqgrid-rownum"), nb && $(e.sDiv).hide()), ob = null, d.p.caption) {
                    ...
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
                        ...
                        return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), f += ", #" + $(e.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function () {
                            b--, 0 === b && ($("span", g).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (nb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function () {
                            b--, 0 === b && ($("span", g).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"), nb && (d.p.datatype = tb, F(), nb = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (nb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }), !1
                    }), nb && (d.p.datatype = "local", $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
                } else
                    $(e.cDiv).hide(), d.p.toppager || $(e.hDiv).addClass("ui-corner-top");
                $(e.hDiv).after(e.bDiv).mousemove(function (a) {
                ...
                }), d.formatCol = n, d.sortData = J, d.updatepager = C, d.refreshIndex = x, d.setHeadCheckBox = G, d.constructTr = y, d.formatter = function (a, b, c, d, e) {
                    return p(a, b, c, d, e)
                }, $.extend(e, {
                    populate: F,
                    emptyRows: v,
                    ...
                    A(a)
                }, this.grid.cols = this.rows[0].cells, $(d).triggerHandler("jqGridInitGrid"), $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d), F(), d.p.hiddengrid = !1
            }
        })
    }, $.jgrid.extend({
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                ...
                void
                    ...
                    0 === i ? null : i), $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(f.id))[l.p.useProp ? "prop" : "attr"]("checked", e), j && (-1 === h ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass("ui-state-highlight") : $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).removeClass("ui-state-highlight"), $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j))[l.p.useProp ? "prop" : "attr"]("checked", e)), b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]), l.p.onSelectRow && l.p.onSelectRow.call(l, f.id, e, c))) : "ui-subgrid" !== f.className && (l.p.selrow !== f.id ? (k = $(l).jqGrid("getGridRowById", l.p.selrow), k && $(k).removeClass("ui-state-highlight").attr({
                    "aria-selected": "false",
                    tabindex: "-1"
            ...
            return this.each(function () {
                ...
                if (d.p.frozenColumns === !0 && (c = d.p.id + "_frozen"), void
                        0 !== a) {
                    if (b = a === d.p.selrow ? d.p.selrow : a, $("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(b)).removeClass("ui-state-highlight").attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass("ui-state-highlight"), d.p.multiselect) {
                        ...
                        var
                            e = $.inArray($.jgrid.jqID(b), d.p.selarrrow);
                        -1 !== e && d.p.selarrrow.splice(e, 1)
                    }
                    b = null
                } else
                ...
                d.p.cellEdit === !0 && parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && ($("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell ui-state-highlight"), $(d.rows[d.p.iRow]).removeClass("selected-row ui-state-hover")), d.p.savedRow = []
            })
            ...
            var
                e, f, g, h, i, j, k, l, m, n, o, p, q, r, s = !1, t = "";
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
                var
                    u = this, v = b.length;
                i = u.p.rownumbers === !0 ? 1 : 0, g = u.p.multiselect === !0 ? 1 : 0, h = u.p.subGrid === !0 ? 1 : 0, m || (void
                    0 !== a ? a = String(a) : (a = $.jgrid.randId(), u.p.keyName !== !1 && (n = u.p.keyName, void
                    0 !== b[0][n] && (a = b[0][n])))), o = u.p.altclass;
                for (var
                         w = 0, x = "", y = {}, z = $.isFunction(u.p.afterInsertRow) ? !0 : !1; v > w;) {
                    if (p = b[w], f = [], m) {
                        try {
                            a = p[n], void
                                0 === a && (a = $.jgrid.randId())
                ...
                if (d.grid) {
                    ...
                    var
                        g = "" === b ? !0 : !1, h = d.p.groupHeader && ("object" == typeof
                                d.p.groupHeader || $.isFunction(d.p.groupHeader));
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        c, d, e, f, g = this, h = 0, i = $.jgrid.cell_width ? 0 : g.p.cellLayout, j = 0, k = !1, l = g.p.scrollOffset, m = 0;
                    if ("boolean" != typeof
            ...
            return this.each(function () {
                this.p.caption = a, $("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl", this.grid.cDiv).html(a), $(this.grid.cDiv).show(), $(this.grid.hDiv).removeClass("ui-corner-top")
            })
            ...
            return this.each(function () {
                var
                    e = this, f = -1;
                if (e.grid && void
                        0 !== a && ($(e.p.colModel).each(function (b) {
                        ...
                        for (; l > m;) {
                            if ($(j.rows[m]).hasClass("jqgrow")) {
                                ...
                                c ? (g = parseFloat(d), isNaN(g) || (i += g, void
                                    0 === f && (f = e = g), e = Math.min(e, g), f = Math.max(f, g), n++)) : h.push(b ? {
                                    id: j.rows[m].id,
                                    value: d
                                } : d)
                            }
            ...
            return a = $.extend({
                ...
                var
                    b = "show" === a.method ? !0 : !1;
                switch ("" !== a.htmlcontent && $("#load_" + $.jgrid.jqID(this.p.id)).html(a.htmlcontent), a.loadtype) {
                    case"disable":
                        break;
                    case"enable":
                        $("#load_" + $.jgrid.jqID(this.p.id)).toggle(b);
                        break;
                    case"block":
                        $("#lui_" + $.jgrid.jqID(this.p.id)).toggle(b), $("#load_" + $.jgrid.jqID(this.p.id)).toggle(b)
                }
            })
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        a = this, b = a.p.colModel, c = 0, d = b.length, e = -1, f = !1;
                    if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                        ...
                        if (e >= 0 && f) {
                            var
                                g = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0, h = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                            a.p.toppager && (g += $(a.grid.topDiv).outerHeight()), a.p.toolbar[0] === !0 && "bottom" !== a.p.toolbar[1] && (g += $(a.grid.uDiv).outerHeight()), a.grid.fhDiv = $('<div style="position:absolute;left:0px;top:' + g + "px;height:" + h + 'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>'), a.grid.fbDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(g, 10) + parseInt(h, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);
                            var
                                i = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                            if (a.p.groupHeader) {
                                $("tr.jqg-first-row-header, tr.jqg-third-row-header", i).each(function () {
                                    $("th:gt(" + e + ")", this).remove()
                                });
                                var
                                    j, k, l = -1, m = -1;
                                $("tr.jqg-second-row-header th", i).each(function () {
                                    return j = parseInt($(this).attr("colspan"), 10), k = parseInt($(this).attr("rowspan"), 10), k && (l++, m++), j && (l += j, m++), l === e ? !1 : void
                                        0
                                }), l !== e && (m = e), $("tr.jqg-second-row-header", i).each(function () {
                                    $("th:gt(" + m + ")", this).remove()
                                })
                            } else
                                $("tr", i).each(function () {
                            ...
                            if ($(i).width(1), $(a.grid.fhDiv).append(i).mousemove(function (b) {
                                    return a.grid.resizing ? (a.grid.dragMove(b), !1) : void
                                        0
                                }), a.p.footerrow) {
                                var
                                    n = $(".ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                                a.grid.fsDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(g, 10) + parseInt(h, 10) + parseInt(n, 10) + 1) + 'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fsDiv);
                                var
                                    o = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                                $("tr", o).each(function () {
                                    $("td:gt(" + e + ")", this).remove()
                                }), $(o).width(1), $(a.grid.fsDiv).append(o)
                            }
                            $(a).bind("jqGridResizeStop.setFrozenColumns", function (b, c, d) {
                            ...
                            }), $(a).bind("jqGridSortCol.setFrozenColumns", function (b, c, d) {
                                var
                                    e = $("tr.ui-jqgrid-labels:last th:eq(" + a.p.lastsort + ")", a.grid.fhDiv), f = $("tr.ui-jqgrid-labels:last th:eq(" + d + ")", a.grid.fhDiv);
                                $("span.ui-grid-ico-sort", e).addClass("ui-state-disabled"), $(e).attr("aria-selected", "false"), $("span.ui-icon-" + a.p.sortorder, f).removeClass("ui-state-disabled"), $(f).attr("aria-selected", "true"), a.p.viewsortcols[0] || a.p.lastsort !== d && ($("span.s-ico", e).hide(), $("span.s-ico", f).show())
                            }), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fbDiv), $(a.grid.bDiv).scroll(function () {
                                $(a.grid.fbDiv).scrollTop($(this).scrollTop())
                                ...
                                $("tr[role=row]", b).each(function () {
                                    ...
                                    $(this).addClass("ui-state-hover"), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).addClass("ui-state-hover")
                                }, function () {
                                    $(this).removeClass("ui-state-hover"), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).removeClass("ui-state-hover")
                                }), $("tr.jqgrow", "#" + $.jgrid.jqID(a.p.id)).hover(function () {
                                    $(this).addClass("ui-state-hover"), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").addClass("ui-state-hover")
                                }, function () {
                                    $(this).removeClass("ui-state-hover"), $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").removeClass("ui-state-hover")
                                })), b = null
                ...
                if (this.grid && this.p.frozenColumns === !0) {
                    ...
                    if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), $(this).unbind(".setFrozenColumns"), a.p.hoverrows === !0) {
                        ...
                        $("#" + $.jgrid.jqID(a.p.id)).bind("mouseover", function (a) {
                            b = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(b).attr("class") && $(b).addClass("ui-state-hover")
                        }).bind("mouseout", function (a) {
                            b = $(a.target).closest("tr.jqgrow"), $(b).removeClass("ui-state-hover")
                        })
                    }
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            if (c.formprop && d && c.form) {
                ...
                var
                    g, h;
                "edit" === c.form ? (g = "#" + a.jgrid.jqID("FrmGrid_" + c.gb.substr(6)), h = "formProp") : "view" === c.form && (g = "#" + a.jgrid.jqID("ViewGrid_" + c.gb.substr(6)), h = "viewProp"), a(d).data(h, {
            ...
            var
                i, j = document.createElement("div"), k = this;
            ...
            var
                m = a("<a class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(function () {
            ...
            a(n).addClass("ui-jqdialog-content ui-widget-content").attr("id", b.modalcontent), a(n).append(c), j.appendChild(n), a(j).prepend(l), g === !0 ? a("body").append(j) : "string" == typeof
            ...
            if (a("a.ui-jqdialog-titlebar-close", l).click(function () {
                ...
                var
                    q = a(e).parents("*[role=dialog]").filter(":first").css("z-index");
            ...
            if (d.resize)if (a.fn.jqResize)a(j).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", b.scrollelm ? "#" + a.jgrid.jqID(b.scrollelm) : !1); else
                try {
            ...
            var
                i, j = "";
            if (f.buttons.length > 0)for (i = 0; i < f.buttons.length; i++)void
                0 === f.buttons[i].id && (f.buttons[i].id = "info_button_" + i), j += "<a id='" + f.buttons[i].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[i].text + "</a>";
            var
                k = isNaN(f.dataheight) ? f.dataheight : f.dataheight + "px", l = "text-align:" + f.align + ";", m = "<div id='info_id'>";
            ...
            switch (b) {
                ...
                case"select":
                    ...
                    if (c.multiple === !0 ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function (b) {
                                var
                                    c, d, e = [], f = this.elem, d = this.vl, h = a.extend({}, this.options), j = h.multiple === !0, k = h.cacheUrlData === !0, l = "", m = a.isFunction(h.buildSelect) ? h.buildSelect.call(i, b) : b;
                                "string" == typeof
                                    m && (m = a(a.trim(m)).html()), m && (a(f).append(m), g(f, h, o ? ["postData"] : void
                                    0), void
                                    0 === h.size && (h.size = j ? 3 : 1), j ? (e = d.split(","), e = a.map(e, function (b) {
                                    return a.trim(b)
                                    ...
                                    if (a("option", f).each(function (b) {
                                        ...
                                        var
                                            b, g = a("#fbox_" + i.p.id)[0].p.columns;
                                        a.each(g, function () {
                                            return b = this.index || this.name, h.name === b ? (this.searchoptions.dataUrl = null, this.searchoptions.value = l, !1) : void
                                                0
                                        })
                                    }
                                }, 0))
                        ...
                        if ("string" == typeof
                                c.value)for (r = c.value.split(v), q = 0; q < r.length; q++)s = r[q].split(u), s.length > 2 && (s[1] = a.map(s, function (a, b) {
                            return b > 0 ? a : void
                                0
                        }).join(u)), t = document.createElement("option"), t.setAttribute("role", "option"), t.value = s[0], t.innerHTML = s[1], h.appendChild(t), l || a.trim(s[0]) !== a.trim(d) && a.trim(s[1]) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(s[1]), m) > -1 || a.inArray(a.trim(s[0]), m) > -1) && (t.selected = "selected"); else if ("[object Array]" === Object.prototype.toString.call(c.value)) {
                            for (var
                                     w = c.value, q = 0; q < w.length; q++)if (2 === w[q].length) {
                                var
                                    x = w[q][0], y = w[q][1];
                            ...
                            for (x
                                in
                                w)w.hasOwnProperty(x) && (t = document.createElement("option"), t.setAttribute("role", "option"), t.value = x, t.innerHTML = w[x], h.appendChild(t), l || a.trim(x) !== a.trim(d) && a.trim(w[x]) !== a.trim(d) || (t.selected = "selected"), l && (a.inArray(a.trim(w[x]), m) > -1 || a.inArray(a.trim(x), m) > -1) && (t.selected = "selected"))
                        }
                        g(h, c, ["value"])
                    }
                    break;
                ...
                case"button":
                    var
                        z;
                    z = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({width: "98%"}) : c.size || (c.size = 20)), a(h).attr("role", z);
                    break;
                case"image":
                case"file":
                ...
                case"custom":
                    ...
                    try {
                        ...
                        var
                            A = c.custom_element.call(i, d, c);
                        if (!A)throw"e2";
                        A = a(A).addClass("customelement").attr({id: c.id, name: c.name}), a(h).empty().append(A)
                    } catch (p) {
                        var
                            B = a.jgrid.getRegional(i, "errors"), C = a.jgrid.getRegional(i, "edit");
                        "e1" === p && a.jgrid.info_dialog(B.errcap, "function 'custom_element' " + C.msg.nodefined, C.bClose), "e2" === p ? a.jgrid.info_dialog(B.errcap, "function 'custom_element' " + C.msg.novalue, C.bClose) : a.jgrid.info_dialog(B.errcap, "string" == typeof
                            p ? p : p.message, C.bClose)
                    }
            }
            return h
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                ...
                function
                e() {
                    return a(x).find(".FormElement").each(function () {
                        var
                            c = a(".customelement", this);
                        if (c.length) {
                            var
                                d = c[0], e = a(d).attr("name");
                            a.each(p.p.colModel, function () {
                                if (this.name === e && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (r[e] = this.editoptions.custom_value.call(p, a("#" + a.jgrid.jqID(e), x), "get"), void
                                                0 === r[e])throw"e1"
                                    } catch (c) {
                                        "e1" === c ? a.jgrid.info_dialog(D.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.novalue, b[a(this)[0]].p.bClose) : a.jgrid.info_dialog(D.errcap, c.message, b[a(this)[0]].p.bClose)
                                    }
                                    return !0
                                }
                            })
                            ...
                            switch (a(this).get(0).type) {
                                case"checkbox":
                                    if (a(this).is(":checked"))r[this.name] = a(this).val(); else {
                                        var
                                    ...
                                    break;
                                case"select-one":
                                    r[this.name] = a("option:selected", this).val();
                                    break;
                                case"select-multiple":
                                    r[this.name] = a(this).val(), r[this.name] = r[this.name] ? r[this.name].join(",") : "";
                                    var
                                        g = [];
                                ...
                                case"textarea":
                                case"button":
                                    r[this.name] = a(this).val()
                            }
                            p.p.autoencode && (r[this.name] = a.jgrid.htmlEncode(r[this.name]))
                        }
                    }), !0
                }
                ...
                f(c, d, e, f) {
                    var
                        g, h, i, j, k, l, m, n = 0, o = [], q = !1, r = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", s = "";
                    for (m = 1; f >= m; m++)s += r;
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (m) {
                            if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                                if (q === !1)j = ""; else if (g === d.p.ExpandColumn && d.p.treeGrid === !0)j = a("td[role='gridcell']:eq(" + m + ")", d.rows[q]).text(); else {
                                    try {
                                ...
                                var
                                    t = a.extend({}, this.editoptions || {}, {
                                        ...
                                        rowabove: !1,
                                        rowcontent: ""
                                    }, this.formoptions || {}), w = parseInt(u.rowpos, 10) || n + 1, x = parseInt(2 * (parseInt(u.colpos, 10) || 1), 10);
                                if ("_empty" === c && t.defaultValue && (j = a.isFunction(t.defaultValue) ? t.defaultValue.call(p) : t.defaultValue), this.edittype || (this.edittype = "text"), p.p.autoencode && (j = a.jgrid.htmlDecode(j)), l = a.jgrid.createEl.call(p, this.edittype, t, j, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (j = a(l).val(), "select-multiple" === a(l).get(0).type && (j = j.join(","))), "checkbox" === this.edittype && (j = a(l).is(":checked") ? a(l).val() : a(l).attr("offval")), (b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) && (b[p.p.id]._savedData[g] = j), a(l).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(l).addClass("ui-widget-content ui-corner-all"), C)a(I).find("#" + g).replaceWith(l); else {
                                    if (i = a(e).find("tr[rowpos=" + w + "]"), u.rowabove) {
                                        var
                                            y = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + u.rowcontent + "</td></tr>");
                                        a(e).append(y), y[0].rp = w
                                    }
                                    0 === i.length && (i = a("<tr " + k + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + g), a(i).append(s), a(e).append(i), i[0].rp = w), a("td:eq(" + (x - 2) + ")", i[0]).html(void
                                        0 === u.label ? d.p.colNames[m] : u.label), a("td:eq(" + (x - 1) + ")", i[0]).append(u.elmprefix).append(l).append(u.elmsuffix)
                                }
                                "custom" === this.edittype && a.isFunction(t.custom_value) && t.custom_value.call(p, a("#" + g, v), "set", j), a.jgrid.bindEv.call(p, l, t), o[n] = m, n++
                            }
                        }), n > 0) {
                        var
                            t;
                        C ? (t = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + d.p.id + "_id' value='" + c + "'/>", a(I).append(t)) : (t = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + d.p.id + "_id' value='" + c + "'/></td></tr>"), t[0].rp = n + 999, a(e).append(t)), (b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) && (b[p.p.id]._savedData[d.p.id + "_id"] = c)
                    }
                    return o
                }
                ...
                g(c, d, e) {
                    ...
                    n && (a('td[role="gridcell"]', n).each(function (h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            switch (p.p.autoencode && (g = a.jgrid.htmlDecode(g)), (b[p.p.id].checkOnSubmit === !0 || b[p.p.id].checkOnUpdate) && (b[p.p.id]._savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                case"password":
                                case"text":
                                case"button":
                                case"image":
                                ...
                                case"select":
                                    ...
                                    }), (b[p.p.id].checkOnSubmit === !0 || b[p.p.id].checkOnUpdate) && (g = a("#" + f, e).val(), m[h].editoptions.multiple && (g = g.join(",")), b[p.p.id]._savedData[f] = g);
                                    break;
                                case"checkbox":
                                    if (g = String(g), m[h].editoptions && m[h].editoptions.value) {
                                        var
                                            k = m[h].editoptions.value.split(":");
                                        a("#" + f, e)[p.p.useProp ? "prop" : "attr"](k[0] === g ? {
                                            checked: !0,
                                            defaultChecked: !0
                                        } : {checked: !1, defaultChecked: !1})
                                    } else
                                        g = g.toLowerCase(), g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[p.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + f, e)[p.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + f, e)[p.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + f, e)[p.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                    (b[p.p.id].checkOnSubmit === !0 || b[p.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"));
                                    break;
                                case"custom":
                                    try {
                                        if (!m[h].editoptions || !a.isFunction(m[h].editoptions.custom_value))throw"e1";
                                        m[h].editoptions.custom_value.call(p, a("#" + f, e), "set", g)
                                    } catch (n) {
                                        "e1" === n ? a.jgrid.info_dialog(D.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.nodefined, a.rp_ge[a(this)[0]].p.bClose) : a.jgrid.info_dialog(D.errcap, n.message, a.rp_ge[a(this)[0]].p.bClose)
                                    }
                            }
                            l++
                        }
                ...
                function
                h() {
                    a.each(p.p.colModel, function (a, b) {
                ...
                i() {
                    var
                        c, e, f, i, j, k, l, m = [!0, "", ""], n = {}, o = p.p.prmNames, q = a(p).triggerHandler("jqGridAddEditBeforeCheckValues", [a(v), t]);
                    q && "object" == typeof
                        q && (r = q), a.isFunction(b[p.p.id].beforeCheckValues) && (q = b[p.p.id].beforeCheckValues.call(p, r, a(v), t), q && "object" == typeof
                        q && (r = q));
                    for (i
                        in
                        r)if (r.hasOwnProperty(i) && (m = a.jgrid.checkValues.call(p, r[i], i), m[0] === !1))break;
                    if (h(), m[0] && (n = a(p).triggerHandler("jqGridAddEditClickSubmit", [b[p.p.id], r, t]), void
                        ...
                        if (b[p.p.id].processing = !0, a("#sData", x + "_2").addClass("ui-state-active"), l = b[p.p.id].url || a(p).jqGrid("getGridParam", "editurl"), f = o.oper, e = "clientArray" === l ? p.p.keyName : o.id, r[f] = "_empty" === a.trim(r[p.p.id + "_id"]) ? o.addoper : o.editoper, r[f] !== o.addoper ? r[e] = r[p.p.id + "_id"] : void
                                0 === r[e] && (r[e] = r[p.p.id + "_id"]), delete
                                r[p.p.id + "_id"], r = a.extend(r, b[p.p.id].editData, n), p.p.treeGrid === !0) {
                            if (r[f] === o.addoper) {
                                j = a(p).jqGrid("getGridParam", "selrow");
                                var
                                    s = "adjacency" === p.p.treeGridModel ? p.p.treeReader.parent_id_field : "parent_id";
                                r[s] = j
                            }
                            for (k
                                in
                                p.p.treeReader)if (p.p.treeReader.hasOwnProperty(k)) {
                                var
                                    w = p.p.treeReader[k];
                                if (r.hasOwnProperty(w)) {
                                    if (r[f] === o.addoper && "parent_id_field" === k)continue;
                                    delete
                                        r[w]
                                }
                            }
                        }
                        r[e] = a.jgrid.stripPref(p.p.idPrefix, r[e]);
                        var
                            z = a.extend({
                                url: l,
                                type: b[p.p.id].mtype,
                                data: a.isFunction(b[p.p.id].serializeEditData) ? b[p.p.id].serializeEditData.call(p, r) : r,
                                complete: function (h, i) {
                                    var
                                        k;
                                    if (a("#sData", x + "_2").removeClass("ui-state-active"), r[e] = p.p.idPrefix + r[e], h.status >= 300 && 304 !== h.status ? (m[0] = !1, m[1] = a(p).triggerHandler("jqGridAddEditErrorTextFormat", [h, t]), m[1] = a.isFunction(b[p.p.id].errorTextFormat) ? b[p.p.id].errorTextFormat.call(p, h, t) : i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (m = a(p).triggerHandler("jqGridAddEditAfterSubmit", [h, r, t]), void
                                            0 === m && (m = [!0, "", ""]), m[0] && a.isFunction(b[p.p.id].afterSubmit) && (m = b[p.p.id].afterSubmit.call(p, h, r, t))), m[0] === !1)a(".FormError", v).html(m[1]), a(".FormError", v).show(); else if (p.p.autoencode && a.each(r, function (b, c) {
                                            r[b] = a.jgrid.htmlDecode(c)
                                        }), r[f] === o.addoper ? (m[2] || (m[2] = a.jgrid.randId()), null == r[e] || "_empty" === r[e] ? r[e] = m[2] : m[2] = r[e], b[p.p.id].reloadAfterSubmit ? a(p).trigger("reloadGrid") : p.p.treeGrid === !0 ? a(p).jqGrid("addChildNode", m[2], j, r) : a(p).jqGrid("addRowData", m[2], r, d.addedrow), b[p.p.id].closeAfterAdd ? (p.p.treeGrid !== !0 && a(p).jqGrid("setSelection", m[2]), a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(u),
                                            jqm: d.jqModal,
                                            onClose: b[p.p.id].onClose,
                                            removemodal: b[p.p.id].removemodal,
                                            formprop: !b[p.p.id].recreateForm,
                                            form: b[p.p.id].form
                                        })) : b[p.p.id].clearAfterAdd && g("_empty", p, v)) : (b[p.p.id].reloadAfterSubmit ? (a(p).trigger("reloadGrid"), b[p.p.id].closeAfterEdit || setTimeout(function () {
                                            a(p).jqGrid("setSelection", r[e])
                                        }, 1e3)) : p.p.treeGrid === !0 ? a(p).jqGrid("setTreeRow", r[e], r) : a(p).jqGrid("setRowData", r[e], r), b[p.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(u),
                                            jqm: d.jqModal,
                                            onClose: b[p.p.id].onClose,
                                            removemodal: b[p.p.id].removemodal,
                                            formprop: !b[p.p.id].recreateForm,
                                            form: b[p.p.id].form
                                        })), a.isFunction(b[p.p.id].afterComplete) && (c = h, setTimeout(function () {
                                            a(p).triggerHandler("jqGridAddEditAfterComplete", [c, r, a(v), t]), b[p.p.id].afterComplete.call(p, c, r, a(v), t), c = null
                                        }, 500)), (b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) && (a(v).data("disabled", !1), "_empty" !== b[p.p.id]._savedData[p.p.id + "_id"]))for (k
                                        in
                                        b[p.p.id]._savedData)b[p.p.id]._savedData.hasOwnProperty(k) && r[k] && (b[p.p.id]._savedData[k] = r[k]);
                                    b[p.p.id].processing = !1;
                                    try {
                                        a(":input:visible", v)[0].focus()
                                    } catch (l) {
                                    }
                                }
                            }, a.jgrid.ajaxOptions, b[p.p.id].ajaxEditOptions);
                        if (z.url || b[p.p.id].useDataProxy || (a.isFunction(p.p.dataProxy) ? b[p.p.id].useDataProxy = !0 : (m[0] = !1, m[1] += " " + D.nourl)), m[0])if (b[p.p.id].useDataProxy) {
                            var
                                A = p.p.dataProxy.call(p, z, "set_" + p.p.id);
                            void
                                0 === A && (A = [!0, ""]), A[0] === !1 ? (m[0] = !1, m[1] = A[1] || "Error deleting the selected row!") : (z.data.oper === o.addoper && b[p.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(u),
                                jqm: d.jqModal,
                                onClose: b[p.p.id].onClose,
                                removemodal: b[p.p.id].removemodal,
                                formprop: !b[p.p.id].recreateForm,
                                form: b[p.p.id].form
                            }), z.data.oper === o.editoper && b[p.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(u),
                                jqm: d.jqModal,
                                onClose: b[p.p.id].onClose,
                                removemodal: b[p.p.id].removemodal,
                        ...
                        } else"clientArray" === z.url ? (b[p.p.id].reloadAfterSubmit = !1, r = z.data, z.complete({
                            status: 200,
                            statusText: ""
                        }, "")) : a.ajax(z)
                    }
                    m[0] === !1 && (a(".FormError", v).html(m[1]), a(".FormError", v).show())
                }
                ...
                j(a, b) {
                    ...
                    for (c
                        in
                        a)if (a.hasOwnProperty(c) && a[c] != b[c]) {
                        d = !0;
                        break
                    }
                    return d
                ...
                k() {
                    var
                        c = !0;
                    return a(".FormError", v).hide(), b[p.p.id].checkOnUpdate && (r = {}, e(), s = j(r, b[p.p.id]._savedData), s && (a(v).data("disabled", !0), a(".confirm", "#" + y.themodal).show(), c = !1)), c
                }
                ...
                l() {
                    var
                        b;
                    if ("_empty" !== c && void
                            0 !== p.p.savedRow && p.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))for (b = 0; b < p.p.savedRow.length; b++)if (p.p.savedRow[b].id === c) {
                        a(p).jqGrid("restoreRow", c);
                        break
                    }
                }
                ...
                m(b, c) {
                    var
                        d = c[1].length - 1;
                    0 === b ? a("#pData", q).addClass("ui-state-disabled") : void
                        ...
                        0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled") ? a("#nData", q).addClass("ui-state-disabled") : a("#nData", q).removeClass("ui-state-disabled")
                }

                function
                n() {
                    var
                        b = a(p).jqGrid("getDataIDs"), c = a("#id_g", x).val(), d = a.inArray(c, b);
                    return [d, b]
                }
                ...
                if (p.grid && c) {
                    var
                        q, r, s, t, u = p.p.id, v = "FrmGrid_" + u, w = "TblGrid_" + u, x = "#" + a.jgrid.jqID(w), y = {
                            themodal: "editmod" + u,
                            modalhead: "edithd" + u,
                            modalcontent: "editcnt" + u,
                            scrollelm: v
                        }, z = !0, A = 1, B = 0, C = "string" == typeof
                                b[p.p.id].template && b[p.p.id].template.length > 0, D = a.jgrid.getRegional(this, "errors");
                    "new" === c ? (c = "_empty", t = "add", d.caption = b[p.p.id].addCaption) : (d.caption = b[p.p.id].editCaption, t = "edit"), d.recreateForm || a(p).data("formProp") && a.extend(b[a(this)[0].p.id], a(p).data("formProp"));
                    var
                        E = !0;
                    d.checkOnUpdate && d.jqModal && !d.modal && (E = !1);
                    var
                        F, G = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight : b[a(this)[0].p.id].dataheight + "px", H = isNaN(b[a(this)[0].p.id].datawidth) ? b[a(this)[0].p.id].datawidth : b[a(this)[0].p.id].datawidth + "px", I = a("<form name='FormPost' id='" + v + "' class='FormGrid' onSubmit='return false;' style='width:" + H + ";overflow:auto;position:relative;height:" + G + ";'></form>").data("disabled", !1);
                    if (C ? (F = o(b[a(this)[0].p.id].template), q = x) : (F = a("<table id='" + w + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), q = x + "_2"), v = "#" + a.jgrid.jqID(v), a(I).append("<div class='FormError ui-state-error' style='display:none;'></div>"), a(I).append("<div class='tinfo topinfo'>" + b[p.p.id].topinfo + "</div>"), a(p.p.colModel).each(function () {
                            var
                                a = this.formoptions;
                            A = Math.max(A, a ? a.colpos || 0 : 0), B = Math.max(B, a ? a.rowpos || 0 : 0)
                        }), a(I).append(F), z = a(p).triggerHandler("jqGridAddEditBeforeInitData", [I, t]), void
                            0 === z && (z = !0), z && a.isFunction(b[p.p.id].beforeInitData) && (z = b[p.p.id].beforeInitData.call(p, I, t)), z !== !1) {
                        l(), f(c, p, F, A);
                        var
                            J = "rtl" === p.p.direction ? !0 : !1, K = J ? "nData" : "pData", L = J ? "pData" : "nData", M = "<a id='" + K + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>", N = "<a id='" + L + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>", O = "<a id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>", P = "<a id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>", Q = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + w + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (J ? N + M : M + N) + "</td><td class='EditButton'>" + O + P + "</td></tr>";
                        ...
                        d.gbox = "#gbox_" + a.jgrid.jqID(u);
                        var
                            S = !1;
                        d.closeOnEscape === !0 && (d.closeOnEscape = !1, S = !0);
                        var
                            T;
                        if (C ? (a(I).find("#pData").replaceWith(M), a(I).find("#nData").replaceWith(N), a(I).find("#sData").replaceWith(O), a(I).find("#cData").replaceWith(P), T = a("<div id=" + w + "></div>").append(I)) : T = a("<div></div>").append(I).append(Q), a(I).append("<div class='binfo topinfo bottominfo'>" + b[p.p.id].bottominfo + "</div>"), a.jgrid.createModal(y, T, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(p.p.id), a("#gbox_" + a.jgrid.jqID(p.p.id))[0]), J && (a("#pData, #nData", x + "_2").css("float", "right"), a(".EditButton", x + "_2").css("text-align", "left")), b[p.p.id].topinfo && a(".tinfo", v).show(), b[p.p.id].bottominfo && a(".binfo", v).show(), T = null, Q = null, a("#" + a.jgrid.jqID(y.themodal)).keydown(function (c) {
                                var
                                    e = c.target;
                                if (a(v).data("disabled") === !0)return !1;
                                if (b[p.p.id].savekey[0] === !0 && c.which === b[p.p.id].savekey[1] && "TEXTAREA" !== e.tagName)return a("#sData", x + "_2").trigger("click"), !1;
                                if (27 === c.which)return k() ? (S && a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                    gb: d.gbox,
                                    jqm: d.jqModal,
                                    onClose: b[p.p.id].onClose,
                                    removemodal: b[p.p.id].removemodal,
                                ...
                                if (b[p.p.id].navkeys[0] === !0) {
                                    if ("_empty" === a("#id_g", x).val())return !0;
                                    if (c.which === b[p.p.id].navkeys[1])return a("#pData", q).trigger("click"), !1;
                                    if (c.which === b[p.p.id].navkeys[2])return a("#nData", q).trigger("click"), !1
                                }
                            }), d.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(y.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(y.themodal)).unbind("click").click(function () {
                                return k() ? (a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(u),
                                    jqm: d.jqModal,
                                    onClose: b[p.p.id].onClose,
                                    removemodal: b[p.p.id].removemodal,
                            ...
                            })), d.saveicon = a.extend([!0, "left", "ui-icon-disk"], d.saveicon), d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon), d.saveicon[0] === !0 && a("#sData", q).addClass("right" === d.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] + "'></span>"), d.closeicon[0] === !0 && a("#cData", q).addClass("right" === d.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>"), b[p.p.id].checkOnSubmit || b[p.p.id].checkOnUpdate) {
                            O = "<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>", N = "<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bNo + "</a>", P = "<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bExit + "</a>";
                            var
                                U = d.zIndex || 999;
                            U++, a("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + U + ";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (U + 1) + "'>" + d.saveData + "<br/><br/>" + O + N + P + "</div>").insertAfter(v), a("#sNew", "#" + a.jgrid.jqID(y.themodal)).click(function () {
                                return i(), a(v).data("disabled", !1), a(".confirm", "#" + a.jgrid.jqID(y.themodal)).hide(), !1
                            }), a("#nNew", "#" + a.jgrid.jqID(y.themodal)).click(function () {
                                return a(".confirm", "#" + a.jgrid.jqID(y.themodal)).hide(), a(v).data("disabled", !1), setTimeout(function () {
                                    a(":input:visible", v)[0].focus()
                                }, 0), !1
                            }), a("#cNew", "#" + a.jgrid.jqID(y.themodal)).click(function () {
                                return a(".confirm", "#" + a.jgrid.jqID(y.themodal)).hide(), a(v).data("disabled", !1), a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(u),
                                    jqm: d.jqModal,
                                    onClose: b[p.p.id].onClose,
                                    removemodal: b[p.p.id].removemodal,
                        ...
                        a(p).triggerHandler("jqGridAddEditInitializeForm", [a(v), t]), a.isFunction(b[p.p.id].onInitializeForm) && b[p.p.id].onInitializeForm.call(p, a(v), t), "_empty" !== c && b[p.p.id].viewPagerButtons ? a("#pData,#nData", q).show() : a("#pData,#nData", q).hide(), a(p).triggerHandler("jqGridAddEditBeforeShowForm", [a(v), t]), a.isFunction(b[p.p.id].beforeShowForm) && b[p.p.id].beforeShowForm.call(p, a(v), t), a("#" + a.jgrid.jqID(y.themodal)).data("onClose", b[p.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(y.themodal), {
                            ...
                            onHide: function (b) {
                                var
                                    c = a("#editmod" + u)[0].style.height;
                                c.indexOf("px") > -1 && (c = parseFloat(c)), a(p).data("formProp", {
                                    top: parseFloat(a(b.w).css("top")),
                                    left: parseFloat(a(b.w).css("left")),
                                    width: a(b.w).width(),
                                    height: c,
                                    dataheight: a(v).height(),
                                    datawidth: a(v).width()
                            ...
                            a(this).removeClass("ui-state-hover")
                        }), a("#sData", q).click(function () {
                            return r = {}, a(".FormError", v).hide(), e(), "_empty" === r[p.p.id + "_id"] ? i() : d.checkOnSubmit === !0 ? (s = j(r, b[p.p.id]._savedData), s ? (a(v).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(y.themodal)).show()) : i()) : i(), !1
                        }), a("#cData", q).click(function () {
                            return k() ? (a.jgrid.hideModal("#" + a.jgrid.jqID(y.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(u),
                                jqm: d.jqModal,
                                onClose: b[p.p.id].onClose,
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(p, "next", a(v), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] + 1])).hasClass("ui-state-disabled"))return !1;
                                g(b[1][b[0] + 1], p, v), a(p).jqGrid("setSelection", b[1][b[0] + 1]), a(p).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a(v), b[1][b[0]]]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(p, "next", a(v), b[1][b[0] + 1]), m(b[0] + 1, b)
                            }
                            return !1
                        }), a("#pData", q).click(function () {
                            if (!k())return !1;
                            a(".FormError", v).hide();
                            var
                                b = n();
                            if (-1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(p, "prev", a(v), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass("ui-state-disabled"))return !1;
                                g(b[1][b[0] - 1], p, v), a(p).jqGrid("setSelection", b[1][b[0] - 1]), a(p).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a(v), b[1][b[0]]]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(p, "prev", a(v), b[1][b[0] - 1]), m(b[0] - 1, b)
                            }
                            return !1
                        }), a(p).triggerHandler("jqGridAddEditAfterShowForm", [a(v), t]), a.isFunction(b[p.p.id].afterShowForm) && b[p.p.id].afterShowForm.call(p, a(v), t);
                        var
                            V = n();
                        m(V[0], V)
                    }
            ...
            return d = a.extend(!0, {
                ...
                f(b, c, e, f) {
                    var
                        g, h, i, j, k, l, m, n, o, p = 0, q = [], r = !1, s = "<td class='CaptionTD form-view-label ui-widget-content' width='" + d.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", t = "", u = "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>", v = ["integer", "number", "currency"], w = 0, x = 0;
                    ...
                    if (a(c.p.colModel).each(function () {
                            ...
                            if (g = this.name, n = !1, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'" : "", o = "boolean" != typeof
                                    this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                                ...
                                if (d.rowabove) {
                                    var
                                        u = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + d.rowcontent + "</td></tr>");
                                    a(e).append(u), u[0].rp = l
                                }
                                i = a(e).find("tr[rowpos=" + l + "]"), 0 === i.length && (i = a("<tr " + k + " rowpos='" + l + "'></tr>").addClass("FormData").attr("id", "trv_" + g), a(i).append(t), a(e).append(i), i[0].rp = l), a("td:eq(" + (s - 2) + ")", i[0]).html("<b>" + (void
                                    0 === d.label ? c.p.colNames[b] : d.label) + "</b>"), a("td:eq(" + (s - 1) + ")", i[0]).append("<span>" + j + "</span>").attr("id", "v_" + g), n && a("td:eq(" + (s - 1) + ") span", i[0]).css({
                                    "text-align": "right",
                                    width: m + "px"
                                }), q[p] = b, p++
                            }
                        ...
                        var
                            y = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + b + "'/></td></tr>");
                ...
                h(b, c) {
                    var
                        d = c[1].length - 1;
                    0 === b ? a("#pData", "#" + m + "_2").addClass("ui-state-disabled") : void
                        ...
                        0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled") ? a("#nData", m + "_2").addClass("ui-state-disabled") : a("#nData", "#" + m + "_2").removeClass("ui-state-disabled")
                }

                function
                i() {
                    var
                        b = a(j).jqGrid("getDataIDs"), c = a("#id_g", "#" + m).val(), d = a.inArray(c, b);
                    return [d, b]
                }
                ...
                if (j.grid && c) {
                    var
                        k = j.p.id, l = "ViewGrid_" + a.jgrid.jqID(k), m = "ViewTbl_" + a.jgrid.jqID(k), n = "ViewGrid_" + k, o = "ViewTbl_" + k, p = {
                            themodal: "viewmod" + k,
                            modalhead: "viewhd" + k,
                    ...
                    if (a(j.p.colModel).each(function () {
                        ...
                        }), a(w).append(x), q && (r = q.call(j, w), void
                            0 === r && (r = !0)), r !== !1) {
                        f(c, j, x, s);
                        var
                        ...
                        var
                            F = a("<div></div>").append(w).append("<table border='0' class='EditTable' id='" + m + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (y ? C + B : B + C) + "</td><td class='EditButton'>" + D + "</td></tr></tbody></table>");
                        a.jgrid.createModal(p, F, d, "#gview_" + a.jgrid.jqID(j.p.id), a("#gview_" + a.jgrid.jqID(j.p.id))[0]), y && (a("#pData, #nData", "#" + m + "_2").css("float", "right"), a(".EditButton", "#" + m + "_2").css("text-align", "left")), d.viewPagerButtons || a("#pData, #nData", "#" + m + "_2").hide(), F = null, a("#" + p.themodal).keydown(function (c) {
                            if (27 === c.which)return b[j.p.id].closeOnEscape && a.jgrid.hideModal("#" + a.jgrid.jqID(p.themodal), {
                                ...
                                jqm: d.jqModal,
                                onClose: d.onClose,
                                removemodal: b[j.p.id].removemodal,
                                formprop: !b[j.p.id].recreateForm,
                                form: b[j.p.id].form
                            }), !1;
                            if (d.navkeys[0] === !0) {
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, g, h, i, j = a.isFunction(b[e.p.id].beforeShowForm), k = a.isFunction(b[e.p.id].afterShowForm), l = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, m = e.p.id, n = {}, o = !0, p = "DelTbl_" + a.jgrid.jqID(m), q = "DelTbl_" + m, r = {
                            themodal: "delmod" + m,
                            modalhead: "delhd" + m,
                            modalcontent: "delcnt" + m,
                            scrollelm: p
                        };
                    if (a.isArray(c) && (c = c.join()), void
                            0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                        if (l && (o = l.call(e, a("#" + p)), void
                                0 === o && (o = !0)), o === !1)return;
                        ...
                        var
                            s = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px", t = isNaN(d.datawidth) ? d.datawidth : d.datawidth + "px", u = "<div id='" + q + "' class='formdata' style='width:" + t + ";overflow:auto;position:relative;height:" + s + ";'>";
                        ...
                        var
                            v = "<a id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>", w = "<a id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                        if (u += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + p + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + v + "&#160;" + w + "</td></tr></tbody></table>", d.gbox = "#gbox_" + a.jgrid.jqID(m), a.jgrid.createModal(r, u, d, "#gview_" + a.jgrid.jqID(e.p.id), a("#gview_" + a.jgrid.jqID(e.p.id))[0]), l && (o = l.call(e, a(u)), void
                                0 === o && (o = !0)), o === !1)return;
                        a(".fm-button", "#" + p + "_2").hover(function () {
                            ...
                            if (n = {}, a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                ...
                                for (c
                                    in
                                    k)k.hasOwnProperty(c) && (k[c] = a.jgrid.stripPref(e.p.idPrefix, k[c]));
                                ...
                                var
                                    l = a.extend({
                                        ...
                                        complete: function (c, g) {
                                            var
                                                h;
                                            if (a("#dData", "#" + p + "_2").removeClass("ui-state-active"), c.status >= 300 && 304 !== c.status ? (j[0] = !1, j[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1)a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show(); else {
                                            ...
                                            b[e.p.id].processing = !1, j[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
                                ...
                                if (l.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (j[0] = !1, j[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), j[0])if (b[e.p.id].useDataProxy) {
                                    var
                                        o = e.p.dataProxy.call(e, l, "del_" + e.p.id);
                                    void
                                        0 === o && (o = [!0, ""]), o[0] === !1 ? (j[0] = !1, j[1] = o[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(m),
                                        jqm: d.jqModal,
                                        onClose: b[e.p.id].onClose
                                    })
                                } else"clientArray" === l.url ? (f = l.data, l.complete({
                                    status: 200,
                                    statusText: ""
                                }, "")) : a.ajax(l)
                            }
            ...
            return c = a.extend({
                ...
                if (!this.p.navGrid) {
                    ...
                    if (n.grid && "string" == typeof
                            b) {
                        a(n).data("navGrid") || a(n).data("navGrid", c), l = a(n).data("navGrid"), n.p.force_regional && (l = a.extend(l, i)), void
                            ...
                            gbox: "#gbox_" + a.jgrid.jqID(n.p.id),
                            jqModal: !0,
                            drag: !0,
                            resize: !0,
                            caption: l.alertcap,
                            ...
                            left: l.alertleft,
                            width: l.alertwidth,
                            height: l.alertheight,
                            closeOnEscape: l.closeOnEscape,
                            zIndex: l.alertzIndex
                        }, "#gview_" + a.jgrid.jqID(n.p.id), a("#gbox_" + a.jgrid.jqID(n.p.id))[0], !0));
                        var
                            o, p = 1, q = function () {
                        ...
                        for (l.cloneToTop && n.p.toppager && (p = 2), o = 0; p > o; o++) {
                            var
                                s, t, u, v = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), w = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>";
                            0 === o ? (t = b, u = n.p.id, t === n.p.toppager && (u += "_top", p = 1)) : (t = n.p.toppager, u = n.p.id + "_top"), "rtl" === n.p.direction && a(v).attr("dir", "rtl").css("float", "right"), e = e || {}, l.add && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.addicon + "'></span>" + l.addtext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.addtitle || "",
                                id: e.id || "add_" + u
                            }).click(function () {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(l.addfunc) ? l.addfunc.call(n) : a(n).jqGrid("editGridRow", "new", e)), !1
                            }).hover(q, r), s = null), d = d || {}, l.edit && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.editicon + "'></span>" + l.edittext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.edittitle || "",
                                id: d.id || "edit_" + u
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var
                                        b = n.p.selrow;
                                    b ? a.isFunction(l.editfunc) ? l.editfunc.call(n, b) : a(n).jqGrid("editGridRow", b, d) : (a.jgrid.viewModal("#" + m.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(n.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                                return !1
                            }).hover(q, r), s = null), h = h || {}, l.view && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.viewicon + "'></span>" + l.viewtext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.viewtitle || "",
                                id: h.id || "view_" + u
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var
                                        b = n.p.selrow;
                                    b ? a.isFunction(l.viewfunc) ? l.viewfunc.call(n, b) : a(n).jqGrid("viewGridRow", b, h) : (a.jgrid.viewModal("#" + m.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(n.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                                return !1
                            }).hover(q, r), s = null), f = f || {}, l.del && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.delicon + "'></span>" + l.deltext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.deltitle || "",
                                id: f.id || "del_" + u
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var
                                        b;
                                    n.p.multiselect ? (b = n.p.selarrrow, 0 === b.length && (b = null)) : b = n.p.selrow, b ? a.isFunction(l.delfunc) ? l.delfunc.call(n, b) : a(n).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + m.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(n.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                                return !1
                            }).hover(q, r), s = null), (l.add || l.edit || l.del || l.view) && a("tr", v).append(w), g = g || {}, l.search && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.searchicon + "'></span>" + l.searchtext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.searchtitle || "",
                                id: g.id || "search_" + u
                            }).click(function () {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(l.searchfunc) ? l.searchfunc.call(n, g) : a(n).jqGrid("searchGrid", g)), !1
                            }).hover(q, r), g.showOnLoad && g.showOnLoad === !0 && a(s, v).click(), s = null), l.refresh && (s = a("<td class='ui-pg-button ui-corner-all'></td>"), a(s).append("<div class='ui-pg-div'><span class='ui-icon " + l.refreshicon + "'></span>" + l.refreshtext + "</div>"), a("tr", v).append(s), a(s, v).attr({
                                title: l.refreshtitle || "",
                                id: "refresh_" + u
                            }).click(function () {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    a.isFunction(l.beforeRefresh) && l.beforeRefresh.call(n), n.p.search = !1, n.p.resetsearch = !0;
                                    try {
                                        if ("currentfilter" !== l.refreshstate) {
                                            var
                                                b = n.p.id;
                                            ...
                                            a.isFunction(n.clearToolbar) && n.clearToolbar.call(n, !1)
                                        }
                                    } catch (d) {
                                    }
                                    switch (l.refreshstate) {
                                        case"firstpage":
                                            a(n).trigger("reloadGrid", [{page: 1}]);
                                            break;
                                        case"current":
                                        case"currentfilter":
                                            a(n).trigger("reloadGrid", [{current: !0}])
                                    }
                                    a.isFunction(l.afterRefresh) && l.afterRefresh.call(n)
                                }
                                return !1
                            }).hover(q, r), s = null), k = a(".ui-jqgrid").css("font-size") || "11px", a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + k + ";visibility:hidden;' ></div>"), j = a(v).clone().appendTo("#testpg2").width(), a("#testpg2").remove(), a(t + "_" + l.position, t).append(v), n.p._nvtd && (j > n.p._nvtd[0] && (a(t + "_" + l.position, t).width(j), n.p._nvtd[0] = j), n.p._nvtd[1] = j), k = null, j = null, v = null, n.p.navGrid = !0
                        }
                        n.p.storeNavOptions && (n.p.navOptions = l, n.p.editOptions = d, n.p.addOptions = e, n.p.delOptions = f, n.p.searchOptions = g, n.p.viewOptions = h)
                    }
                }
            })
            ...
            return c = a.extend({
                ...
                if (this.grid) {
                    ...
                    var
                        d = a(".navtable", b)[0], e = this;
                    if (d) {
                        if (c.id && void
                                0 !== a("#" + a.jgrid.jqID(c.id), d)[0])return;
                        var
                            f = a("<td></td>");
            ...
            return c = a.extend({
                ...
                if (this.grid) {
                    ...
                    if (d) {
                        var
                            e = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='" + c.sepclass + "'></span>" + c.sepcontent + "</td>";
        ...
        return this.each(function () {
            if (!this.filter) {
                this.p = e, (null === this.p.filter || void
                    0 === this.p.filter) && (this.p.filter = {groupOp: this.p.groupOps[0].op, rules: [], groups: []});
                var
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    for (b = 0; d > b; b++)c = this.p.columns[b], c.stype ? c.inputtype = c.stype : c.inputtype || (c.inputtype = "text"), c.sorttype ? c.searchtype = c.sorttype : c.searchtype || (c.searchtype = "string"), void
                        0 === c.hidden && (c.hidden = !1), c.label || (c.label = c.name), c.index && (c.name = c.index), c.hasOwnProperty("searchoptions") || (c.searchoptions = {}), c.hasOwnProperty("searchrules") || (c.searchrules = {});
                    ...
                    this.onchange = function () {
                        ...
                        var
                            d, f = this, g = a("<table class='group ui-widget ui-widget-content ui-search-table' style='border:0px none;'><tbody></tbody></table>"), h = "left";
                        ...
                        g.append(i);
                        var
                            j = a("<th colspan='5' align='" + h + "'></th>");
                        if (i.append(j), this.p.ruleButtons === !0) {
                            var
                                k = a("<select class='opsel ui-widget-content ui-corner-all'></select>");
                            j.append(k);
                            var
                                l, m = "";
                        ...
                        var
                            n = "<span></span>";
                        if (this.p.groupButton && (n = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group ui-widget-content ui-corner-all'/>"), n.bind("click", function () {
                                return void
                            ...
                            var
                                o, p = a("<input type='button' value='+' title='Add rule' class='add-rule ui-add ui-widget-content ui-corner-all'/>");
                        ...
                        if (null !== c) {
                            var
                                q = a("<input type='button' value='-' title='Delete group' class='delete-group ui-widget-content ui-corner-all'/>");
                        ...
                        if (void
                                ...
                                0 !== b.rules)for (d = 0; d < b.rules.length; d++)g.append(this.createTableRowForRule(b.rules[d], b));
                        return g
                    }, this.createTableRowForRule = function (b, c) {
                        var
                            d, h, i, j, k, l = this, m = g(), n = a("<tr></tr>"), o = "";
                        n.append("<td class='first'></td>");
                        var
                            p = a("<td class='columns'></td>");
                        n.append(p);
                        var
                            q, r = a("<select class='ui-widget-content ui-corner-all'></select>"), s = [];
                        p.append(r), r.bind("change", function () {
                            ...
                            if (j) {
                                j.searchoptions.id = a.jgrid.randId(), j.searchoptions.name = b.field, j.searchoptions.oper = "filter", f && "text" === j.inputtype && (j.searchoptions.size || (j.searchoptions.size = 10));
                                var
                                    c = a.jgrid.createEl.call(m, j.inputtype, j.searchoptions, "", !0, l.p.ajaxSelectOptions || {}, !0);
                                a(c).addClass("input-elm ui-widget-content ui-corner-all"), h = j.searchoptions.sopt ? j.searchoptions.sopt : l.p.sopt ? l.p.sopt : -1 !== a.inArray(j.searchtype, l.p.strarr) ? l.p.stropts : l.p.numopts;
                                var
                                    e = "", g = 0;
                                ...
                                if (a(".selectopts", i).empty().append(e), a(".selectopts", i)[0].selectedIndex = 0, a.jgrid.msie && a.jgrid.msiever() < 9) {
                                    var
                                        k = parseInt(a("select.selectopts", i)[0].offsetWidth, 10) + 1;
                        ...
                        for (d = 0; d < l.p.columns.length; d++) {
                            var
                                u = void
                                    0 === l.p.columns[d].search ? !0 : l.p.columns[d].search, v = l.p.columns[d].hidden === !0, w = l.p.columns[d].searchoptions.searchhidden === !0;
                        ...
                        r.append(o);
                        var
                            x = a("<td class='operators'></td>");
                        n.append(x), j = e.columns[t], j.searchoptions.id = a.jgrid.randId(), f && "text" === j.inputtype && (j.searchoptions.size || (j.searchoptions.size = 10)), j.searchoptions.name = b.field, j.searchoptions.oper = "filter";
                        var
                            y = a.jgrid.createEl.call(m, j.inputtype, j.searchoptions, b.data, !0, l.p.ajaxSelectOptions || {}, !0);
                        ("nu" === b.op || "nn" === b.op) && (a(y).attr("readonly", "true"), a(y).attr("disabled", "true"));
                        var
                            z = a("<select class='selectopts ui-widget-content ui-corner-all'></select>");
                        ...
                        z.append(o);
                        var
                            A = a("<td class='data'></td>");
                        n.append(A), A.append(y), a.jgrid.bindEv.call(m, y, j.searchoptions), a(y).addClass("input-elm ui-widget-content ui-corner-all").bind("change", function () {
                        ...
                        if (n.append(B), this.p.ruleButtons === !0) {
                            var
                                C = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del ui-widget-content ui-corner-all'/>");
                        ...
                        var
                            c, d, f, g, i = "", j = "", k = ["int", "integer", "float", "number", "currency"];
                        ...
                        return void
                            0 === d ? "" : (g = b.data, ("bw" === j || "bn" === j) && (g += "%"), ("ew" === j || "en" === j) && (g = "%" + g), ("cn" === j || "nc" === j) && (g = "%" + g + "%"), ("in" === j || "ni" === j) && (g = " (" + g + ")"), e.errorcheck && h(b.data, d), f = -1 !== a.inArray(d.searchtype, k) || "nn" === j || "nu" === j ? b.field + " " + i + " " + g : b.field + " " + i + ' "' + g + '"')
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        e, f = function () {
                            ...
                            a.each(d.p.colModel, function () {
                                var
                                    j = a("#gs_" + d.p.idPrefix + a.jgrid.jqID(this.name), this.frozen === !0 && d.p.frozenColumns === !0 ? d.grid.fhDiv : d.grid.hDiv);
                            ...
                            if (b.stringResult === !0 || "local" === d.p.datatype || b.searchOperators === !0) {
                                ...
                                a.extend(d.p.postData, g);
                            var
                                m;
                            d.p.searchurl && (m = d.p.url, a(d).jqGrid("setGridParam", {url: d.p.searchurl}));
                            var
                                n = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                            ...
                            a("#sopt_menu").remove(), e = parseInt(e, 10), g = parseInt(g, 10) + 18;
                            for (var
                                     h, i, j = a(".ui-jqgrid-view").css("font-size") || "11px", k = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + j + ";left:" + e + "px;top:" + g + 'px;">', l = a(c).attr("soper"), m = [], n = 0, o = a(c).attr("colname"), p = d.p.colModel.length; p > n && d.p.colModel[n].name !== o;)n++;
                            var
                                q = d.p.colModel[n], r = a.extend({}, q.searchoptions);
                    ...
                    a.each(d.p.colModel, function (c) {
                        ...
                        if (this.hidden === !0 && a(r).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void
                            ...
                            a.jgrid.bindEv.call(d, n, g)
                        }
                        a(r).append(s), a(j).append(r), b.searchOperators || a("td:eq(0)", t).hide()
                    }), a("table thead", d.grid.hDiv).append(j), b.searchOperators && (a(".soptclass", j).click(function (b) {
                        var
                            c = a(this).offset(), d = c.left, e = c.top;
                        i(this, d, e), b.stopPropagation()
                    }), a("body").on("click", function (b) {
                        "soptclass" !== b.target.className && a("#sopt_menu").hide()
                    })), a(".clearsearchclass", j).click(function () {
                        var
                            c = a(this).parents("tr:first"), e = parseInt(a("td.ui-search-oper", c).attr("colindex"), 10), g = a.extend({}, d.p.colModel[e].searchoptions || {}), h = g.defaultValue ? g.defaultValue : "";
                        "select" === d.p.colModel[e].stype ? h ? a("td.ui-search-input select", c).val(h) : a("td.ui-search-input select", c)[0].selectedIndex = 0 : a("td.ui-search-input input", c).val(h), b.autosearch === !0 && f()
                    }), this.p.filterToolbar = !0, this.triggerToolbar = f, this.clearToolbar = g, this.toggleToolbar = h
                }
            })
            ...
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if ("string" == typeof
                        ...
                        var
                            k = a("<div><div id='" + f + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)), l = "left", m = "";
                        "rtl" === d.p.direction && (l = "right", m = " style='text-align:left'", k.attr("dir", "rtl"));
                        var
                            n, o, p = a.extend([], d.p.colModel), q = "<a id='" + f + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>", r = "<a id='" + f + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>", s = "", t = "", u = !1, v = -1;
                        if (b.showQuery && (s = "<a id='" + f + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (p = b.columns, v = 0, n = p[0].index || p[0].name) : a.each(p, function (a, b) {
                                if (b.label || (b.label = d.p.colNames[a]), !u) {
                                    var
                                        c = void
                                            0 === b.search ? !0 : b.search, e = b.hidden === !0, f = b.searchoptions && b.searchoptions.searchhidden === !0;
                                    (f && c || c && !e) && (u = !0, n = b.index || b.name, v = a)
                                }
                            }), !j && n || b.multipleSearch === !1) {
                            var
                                w = "eq";
                            v >= 0 && p[v].searchoptions && p[v].searchoptions.sopt ? w = p[v].searchoptions.sopt[0] : b.sopt && b.sopt.length && (w = b.sopt[0]), j = {
                                groupOp: "AND",
                                rules: [{field: n, op: w, data: ""}]
                            }
                        }
                        u = !1, b.tmplNames && b.tmplNames.length && (u = !0, t = b.tmplLabel, t += "<select class='ui-template'>", t += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                            t += "<option value='" + a + "'>" + b + "</option>"
                        }), t += "</select>"), o = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + f + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + l + "'>" + r + t + "</td><td class='EditButton' " + m + ">" + s + q + "</td></tr></tbody></table>", f = a.jgrid.jqID(f), a("#" + f).jqFilter({
                            columns: p,
                            ...
                            id: d.p.id
                        }), k.append(o), u && b.tmplFilters && b.tmplFilters.length && a(".ui-template", k).bind("change", function () {
                            var
                                c = a(this).val();
                            return "default" === c ? a("#" + f).jqFilter("addFilter", j) : a("#" + f).jqFilter("addFilter", b.tmplFilters[parseInt(c, 10)]), !1
                        }), b.multipleGroup === !0 && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f, b.layer ? a.jgrid.createModal(i, k, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {position: "relative"}) : a.jgrid.createModal(i, k, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(i.themodal)).keydown(function (c) {
                            var
                                d = a(c.target);
                        ...
                        }), s && a("#" + f + "_query").bind("click", function () {
                            return a(".queryresult", k).toggle(), !1
                        }), void
                            ...
                            var
                                c = {}, e = a("#" + f);
                            return d.p.search = !1, d.p.resetsearch = !0, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", e[0].resetFilter(), u && a(".ui-template", k).val("default"), a.extend(d.p.postData, c), h = a(d).triggerHandler("jqGridFilterReset"), void
                        ...
                        }), c(a("#" + f)), a(".fm-button:not(.ui-state-disabled)", k).hover(function () {
                            a(this).addClass("ui-state-hover")
                        }, function () {
                            a(this).removeClass("ui-state-hover")
                        })
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void
                ...
                var
                    c, d, e, f, g, h, i = this, j = 0, l = null, m = {};
                i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1 && (h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void
                    0, void
                    0 === h && (h = !0), h && (e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
                    c = g[e].name;
                    var
                    ...
                    if ("cb" !== c && "subgrid" !== c && "rn" !== c && (i.p.autoencode && (d = a.jgrid.htmlDecode(d)), m[c] = d, g[e].editable === !0)) {
                        ...
                        var
                            n = a.jgrid.createEl.call(i, g[e].edittype, k, d, !0, a.extend({}, a.jgrid.ajaxOptions, i.p.ajaxSelectOptions || {}));
                        a(n).addClass("editable"), f ? a("span:first", this).append(n) : a(this).append(n), a.jgrid.bindEv.call(i, n, k), "select" === g[e].edittype && void
                            0 !== g[e].editoptions && g[e].editoptions.multiple === !0 && void
                            0 === g[e].editoptions.dataUrl && a.jgrid.msie && a(n).width(a(n).width()), j++
                    }
            ...
            if (void
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function (b) {
                            if (y = k.p.colModel[b], l = y.name, "cb" !== l && "subgrid" !== l && y.editable === !0 && "rn" !== l && !a(this).hasClass("not-editable-cell")) {
                                switch (y.edittype) {
                                    case"checkbox":
                                        var
                                            c = ["Yes", "No"];
                                        y.editoptions && (c = y.editoptions.value.split(":")), r[l] = a("input", this).is(":checked") ? c[0] : c[1];
                                        break;
                                    case"text":
                                    case"password":
                                    case"textarea":
                                    ...
                                    case"select":
                                        ...
                                        y.formatter && "select" === y.formatter && (s = {});
                                        break;
                                    case"custom":
                                        try {
                                            if (!y.editoptions || !a.isFunction(y.editoptions.custom_value))throw"e1";
                                            if (r[l] = y.editoptions.custom_value.call(k, a(".customelement", this), "get"), void
                                                    0 === r[l])throw"e2"
                                        } catch (f) {
                                            "e1" === f && a.jgrid.info_dialog(v.errcap, "function 'custom_value' " + w.msg.nodefined, w.bClose), "e2" === f ? a.jgrid.info_dialog(v.errcap, "function 'custom_value' " + w.msg.novalue, w.bClose) : a.jgrid.info_dialog(v.errcap, f.message, w.bClose)
                                        }
                                }
                                if (o = a.jgrid.checkValues.call(k, r[l], b), o[0] === !1)return !1;
                                k.p.autoencode && (r[l] = a.jgrid.htmlEncode(r[l])), "clientArray" !== j.url && y.editoptions && y.editoptions.NullIfEmpty === !0 && "" === r[l] && (t[l] = "null", u = !0)
                            }
                        }), o[0] === !1) {
                        try {
                            var
                                z = a(k).jqGrid("getGridRowById", b), A = a.jgrid.findPos(z);
                            a.jgrid.info_dialog(v.errcap, o[1], w.bClose, {left: A[0], top: A[1] + a(z).outerHeight()})
                        } catch (B) {
                            alert(o[1])
                        }
                        return q
                    ...
                    var
                        C, D = k.p.prmNames, E = b;
                    if (C = k.p.keyName === !1 ? D.id : k.p.keyName, r) {
                        if (r[D.oper] = D.editoper, void
                                0 === r[C] || "" === r[C])r[C] = b; else if (p.id !== k.p.idPrefix + r[C]) {
                            var
                                F = a.jgrid.stripPref(k.p.idPrefix, b);
                            if (void
                                    0 !== k.p._index[F] && (k.p._index[r[C]] = k.p._index[F], delete
                                    k.p._index[F]), b = k.p.idPrefix + r[C], a(p).attr("id", b), k.p.selrow === E && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
                                var
                                    G = a.inArray(E, k.p.selarrrow);
                                G >= 0 && (k.p.selarrrow[G] = b)
                            }
                            if (k.p.multiselect) {
                                var
                                    H = "jqg_" + k.p.id + "_" + b;
                                a("input.cbox", p).attr("id", H).attr("name", H)
                            }
                        }
                        void
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        var
                            I, J = a(k).jqGrid("setRowData", b, r);
                        for (a(p).attr("editable", "0"), I = 0; I < k.p.savedRow.length; I++)if (String(k.p.savedRow[I].id) === String(E)) {
                            n = I;
                            break
                        }
                        n >= 0 && k.p.savedRow.splice(n, 1), a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, J, r, j]), a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, J, r, j), q = !0, a(p).removeClass("jqgrid-new-row").unbind("keydown")
                    } else
                        a(k).jqGrid("progressBar", {
                            method: "show",
                            loadtype: j.saveui,
                            htmlcontent: j.savetext
                        }), t = a.extend({}, r, t), t[C] = a.jgrid.stripPref(k.p.idPrefix, t[C]), a.ajax(a.extend({
                            url: j.url,
                            ...
                            error: function (c, d, e) {
                                if (a("#lui_" + a.jgrid.jqID(k.p.id)).hide(), a(k).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, e, j]), a.isFunction(j.errorfunc))j.errorfunc.call(k, b, c, d, e); else {
                                    ...
                                    try {
                                        a.jgrid.info_dialog(v.errcap, '<div class="ui-state-error">' + f + "</div>", w.bClose, {buttonalign: "right"})
                                    } catch (g) {
                                        alert(f)
                                    }
                                }
                ...
                if (this.grid) {
                    var
                        c = this, d = a.isFunction(b.beforeAddRow) ? b.beforeAddRow.call(c, b.addRowParams) : void
                            0;
                    if (void
                            0 === d && (d = !0), d)if (b.rowID = a.isFunction(b.rowID) ? b.rowID.call(c, b) : null != b.rowID ? b.rowID : a.jgrid.randId(), b.useDefValues === !0 && a(c.p.colModel).each(function () {
            ...
            var
                d = a.jgrid.getRegional(this[0], "nav");
            return c = a.extend(!0, {
                edit: !0,
                editicon: "ui-icon-pencil",
                add: !0,
            ...
            }, d, c || {}), this.each(function () {
                if (this.grid && !this.p.inlineNav) {
                    var
                        e = this, f = a.jgrid.jqID(e.p.id);
                    if (e.p.navGrid || a(e).jqGrid("navGrid", b, {
                            refresh: !1,
                            edit: !1,
                            add: !1,
                            del: !1,
                            search: !1,
                            view: !1
                        }), a(e).data("inlineNav") || a(e).data("inlineNav", c), e.p.force_regional && (c = a.extend(c, d)), e.p.inlineNav = !0, c.addParams.useFormatter === !0) {
                        var
                            g, h = e.p.colModel;
                    ...
                    c.add && a(e).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function () {
                            var
                                b = a(e).jqGrid("getGridParam", "selrow");
                            b ? (a(e).jqGrid("editRow", b, c.editParams), a("#" + f + "_ilsave").removeClass("ui-state-disabled"), a("#" + f + "_ilcancel").removeClass("ui-state-disabled"), a("#" + f + "_iladd").addClass("ui-state-disabled"), a("#" + f + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod_" + f, {
                                gbox: "#gbox_" + f,
                                jqm: !0
                            }), a("#jqg_alrt").focus())
                        }
                        ...
                        onClickButton: function () {
                            ...
                            if (b) {
                                var
                                    d = e.p.prmNames, g = d.oper, h = c.editParams;
                        ...
                        onClickButton: function () {
                            var
                                b = e.p.savedRow[0].id, d = c.editParams;
                    ...
                    }), a("#" + f + "_ilcancel").addClass("ui-state-disabled")), c.restoreAfterSelect === !0 && a(e).bind("jqGridBeforeSelectRow.inlineNav", function (b, d) {
                        e.p.savedRow.length > 0 && e.p.inlineNav === !0 && d !== e.p.selrow && null !== e.p.selrow && (e.p.selrow === c.addParams.rowID ? a(e).jqGrid("delRowData", e.p.selrow) : a(e).jqGrid("restoreRow", e.p.selrow, c.editParams), a(e).jqGrid("showAddEditButtons"))
                    })
                }
            })
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c))parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")), g.addClass("edit-cell ui-state-highlight"), a(i.rows[b]).addClass("selected-row ui-state-hover"), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
                            ...
                            if (i.p.autoencode && (f = a.jgrid.htmlDecode(f)), h.edittype || (h.edittype = "text"), i.p.savedRow.push({
                                ...
                                var
                                    k = i.p.formatCell.call(i, i.rows[b].id, e, f, b, c);
                                void
                                    0 !== k && (f = k)
                            }
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.cellEdit === !0) {
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        var
                            h, i, j = a("td:eq(" + c + ")", e.rows[b]), k = e.p.colModel[c], l = k.name, m = a.jgrid.jqID(l);
                        switch (k.edittype) {
                            case"select":
                                if (k.editoptions.multiple) {
                                    var
                                        n = a("#" + b + "_" + m, e.rows[b]), o = [];
                                    h = a(n).val(), h ? h.join(",") : h = "", a("option:selected", n).each(function (b, c) {
                                        o[b] = a(c).text()
                                    }), i = o.join(",")
                                } else
                            ...
                            case"checkbox":
                                var
                                    p = ["Yes", "No"];
                                k.editoptions && (p = k.editoptions.value.split(":")), h = a("#" + b + "_" + m, e.rows[b]).is(":checked") ? p[0] : p[1], i = h;
                                break;
                            case"password":
                            case"text":
                            case"textarea":
                            ...
                            case"custom":
                                try {
                                    ...
                                    "e1" === q && a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose), "e2" === q ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose) : a.jgrid.info_dialog(f.errcap, q.message, g.bClose)
                                }
                        }
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (t[0] === !0) {
                                var
                                    u = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, l, h, b, c]) || {};
                                if (a.isFunction(e.p.beforeSubmitCell) && (u = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), u || (u = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)if (e.p.cellurl) {
                                    var
                                        v = {};
                                    e.p.autoencode && (h = a.jgrid.htmlEncode(h)), v[l] = h;
                                    var
                                        w, x, y;
                                    y = e.p.prmNames, w = y.id, x = y.oper, v[w] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), v[x] = y.editoper, v = a.extend(u, v), a(e).jqGrid("progressBar", {
                                        method: "show",
                                        loadtype: e.p.loadui,
                                        htmlcontent: a.jgrid.getRegional(e, "defaults.savetext")
                                    }), e.grid.hDiv.loading = !0, a.ajax(a.extend({
                                        url: e.p.cellurl,
                                        data: a.isFunction(e.p.serializeCellData) ? e.p.serializeCellData.call(e, v) : v,
                                        type: "POST",
                                        complete: function (d, k) {
                                            if (a(e).jqGrid("progressBar", {
                                                ...
                                                var
                                                    m = a(e).triggerHandler("jqGridAfterSubmitCell", [e, d, v.id, l, h, b, c]) || [!0, ""];
                                                m[0] === !0 && a.isFunction(e.p.afterSubmitCell) && (m = e.p.afterSubmitCell.call(e, d, v.id, l, h, b, c)), m[0] === !0 ? (a(j).empty(), a(e).jqGrid("setCell", e.rows[b].id, c, i, !1, !1, !0), a(j).addClass("dirty-cell"), a(e.rows[b]).addClass("edited"), a(e).triggerHandler("jqGridAfterSaveCell", [e.rows[b].id, l, h, b, c]), a.isFunction(e.p.afterSaveCell) && e.p.afterSaveCell.call(e, e.rows[b].id, l, h, b, c), e.p.savedRow.splice(0, 1)) : (a.jgrid.info_dialog(f.errcap, m[1], g.bClose), a(e).jqGrid("restoreCell", b, c))
                                            }
                                        },
                                        error: function (d, h, i) {
                                            a("#lui_" + a.jgrid.jqID(e.p.id)).hide(), e.grid.hDiv.loading = !1, a(e).triggerHandler("jqGridErrorCell", [d, h, i]), a.isFunction(e.p.errorCell) ? (e.p.errorCell.call(e, d, h, i), a(e).jqGrid("restoreCell", b, c)) : (a.jgrid.info_dialog(f.errcap, d.status + " : " + d.statusText + "<br/>" + h, g.bClose), a(e).jqGrid("restoreCell", b, c))
                                        }
                                    }, a.jgrid.ajaxOptions, e.p.ajaxCellOptions || {}))
                                } else
                                    try {
                                        a.jgrid.info_dialog(f.errcap, f.nourl, g.bClose), a(e).jqGrid("restoreCell", b, c)
                                    } catch (q) {
                                    }
    ...
    a.jgrid.extend({
        setSubGrid: function () {
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    var
                        e, f, g, h, i, j = function (b, c, e) {
                            var
                                f = a("<td align='" + d.p.subGridModel[0].align[e] + "'></td>").html(c);
                            a(b).append(f)
                        }, k = function (b, c) {
                            var
                                e, f, g, h = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), i = a("<tr></tr>");
                            ...
                            var
                                k = a("table:first", d.grid.bDiv).attr("id") + "_";
                            return a("#" + a.jgrid.jqID(k + c)).append(h), d.grid.hDiv.loading = !1, a("#load_" + a.jgrid.jqID(d.p.id)).hide(), !1
                        }, l = function (b, c) {
                            var
                                e, f, g, h, i, k, l = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), m = a("<tr></tr>");
                            ...
                            if (a(l).append(m), b && (i = d.p.jsonReader.subgrid, f = a.jgrid.getAccessor(b, i.root), void
                                ...
                                if (h = f[g], m = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), i.repeatitems === !0)for (i.cell && (h = h[i.cell]), k = 0; k < h.length; k++)j(m, h[k] || "&#160;", k); else {
                                    var
                                        n = d.p.subGridModel[0].mapping || d.p.subGridModel[0].name;
                                    if (n.length)for (k = 0; k < n.length; k++)j(m, h[n[k]] || "&#160;", k)
                                }
                                a(l).append(m)
                            }
                            var
                                o = a("table:first", d.grid.bDiv).attr("id") + "_";
                    ...
                    var
                        o = d.rows.length, p = 1;
                    for (void
                             0 !== c && c > 0 && (p = c, o = c + 1); o > p;)a(d.rows[p]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[p].cells[b]).unbind("click"), a(d.rows[p].cells[b]).bind("click", function () {
                        var
                        ...
                        if (f = d.p.id, e = c.id, i = a("#" + f + "_" + e + "_expandedContent"), a(this).hasClass("sgcollapsed")) {
                            ...
                            d.p.subGridOptions.reloadOnExpand === !0 || d.p.subGridOptions.reloadOnExpand === !1 && !i.hasClass("ui-subgrid") ? (g = b >= 1 ? "<td colspan='" + b + "'>&#160;</td>" : "", a(c).after("<tr role='row' id='" + f + "_" + e + "_expandedContent' class='ui-subgrid ui-sg-expanded'>" + g + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " + d.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(d.p.colNames.length - 1 - n, 10) + "' class='ui-widget-content subgrid-data'><div id=" + f + "_" + e + " class='tablediv'></div></td></tr>"), a(d).triggerHandler("jqGridSubGridRowExpanded", [f + "_" + e, e]), a.isFunction(d.p.subGridRowExpanded) ? d.p.subGridRowExpanded.call(d, f + "_" + e, e) : m(c)) : i.show().removeClass("ui-sg-collapsed").addClass("ui-sg-expanded"), a(this).html("<a style='cursor:pointer;'><span class='ui-icon " + d.p.subGridOptions.minusicon + "'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded"), d.p.subGridOptions.selectOnExpand && a(d).jqGrid("setSelection", e)
                            ...
                            d.p.subGridOptions.reloadOnExpand === !0 ? i.remove(".ui-subgrid") : i.hasClass("ui-subgrid") && i.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"), a(this).html("<a style='cursor:pointer;'><span class='ui-icon " + d.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"), d.p.subGridOptions.selectOnCollapse && a(d).jqGrid("setSelection", e)
                        }
                        return !1
                    })), p++;
...
!function (a) {
    ...
    a.jgrid.extend({
        groupingSetup: function () {
            return this.each(function () {
                var
                    b, c, d, e = this, f = e.p.colModel, g = e.p.groupingView;
                if (null === g || "object" != typeof
                        g && !a.isFunction(g))e.p.grouping = !1; else if (g.groupField.length) {
                    for (void
            ...
            return this.each(function () {
                ...
                if (n.hasClass(j)) {
                    ...
                    } else if (m)for (; m && (g = o(m.className), !(void
                        0 !== g && f >= g));)a(m).hide(), m = m.nextSibling, r && (a(t).hide(), t = t.nextSibling);
            ...
            return this.each(function () {
                ...
                var
                    h, i, j, k = this, l = k.p.groupingView, m = "", n = "", o = l.groupCollapse ? l.plusicon : l.minusicon, p = [], q = l.groupField.length;
                ...
                var
                    r, s = 0, t = a.makeArray(l.groupSummary);
                t.reverse(), r = k.p.multiselect ? ' colspan="2"' : "", a.each(l.groups, function (f, u) {
                    if (l._locgr && !(u.startRow + u.cnt > (d - 1) * e && u.startRow < d * e))return !0;
                    s++, i = k.p.id + "ghead_" + u.idx, h = i + "_" + f, n = "<span style='cursor:pointer;' class='ui-icon " + o + "' onclick=\"jQuery('#" + a.jgrid.jqID(k.p.id) + "').jqGrid('groupingToggle','" + h + "');return false;\"></span>";
                    try {
                        a.isArray(l.formatDisplayField) && a.isFunction(l.formatDisplayField[u.idx]) ? (u.displayValue = l.formatDisplayField[u.idx].call(k, u.displayValue, u.value, k.p.colModel[p[u.idx]], u.idx, l), j = u.displayValue) : j = k.formatter(h, u.displayValue, p[u.idx], u.value)
                    } catch (v) {
                        j = u.displayValue
                    }
                    var
                        w = "";
                    w = a.isFunction(l.groupText[u.idx]) ? l.groupText[u.idx].call(k, j, u.cnt, u.summary) : a.jgrid.template(l.groupText[u.idx], j, u.cnt, u.summary), "string" != typeof
                        w && "number" != typeof
                        w && (w = j), "header" === l.groupSummaryPos[u.idx] ? (m += '<tr id="' + h + '"' + (l.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + k.p.direction + " " + i + '"><td style="padding-left:' + 12 * u.idx + 'px;"' + r + ">" + n + w + "</td>", m += g(f, 0, l.groups, l.groupColumnShow[u.idx] === !1 ? "" === r ? 2 : 3 : "" === r ? 1 : 2), m += "</tr>") : m += '<tr id="' + h + '"' + (l.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + k.p.direction + " " + i + '"><td style="padding-left:' + 12 * u.idx + 'px;" colspan="' + (l.groupColumnShow[u.idx] === !1 ? c - 1 : c) + '">' + n + w + "</td></tr>";
                    var
                        x = q - 1 === u.idx;
                    if (x) {
                        var
                            y, z, A = l.groups[f + 1], B = 0, C = u.startRow, D = void
                                0 !== A ? A.startRow : l.groups[f].startRow + l.groups[f].cnt;
                        for (l._locgr && (B = (d - 1) * e, B > u.startRow && (C = B)), y = C; D > y && b[y - B]; y++)m += b[y - B].join("");
                        if ("header" !== l.groupSummaryPos[u.idx]) {
                            var
                                E;
                            if (void
                                    0 !== A) {
                                for (E = 0; E < l.groupField.length && A.dataIndex !== l.groupField[E]; E++);
                                s = l.groupField.length - E
                            }
                            for (z = 0; s > z; z++)if (t[z]) {
                                var
                                    F = "";
                                l.groupCollapse && !l.showSummaryOnHide && (F = ' style="display:none;"'), m += "<tr" + F + ' jqfootlevel="' + (u.idx - z) + '" role="row" class="ui-widget-content jqfoot ui-row-' + k.p.direction + '">', m += g(f, z, l.groups, 0), m += "</tr>"
                            }
                            s = E
                        }
                    }
            ...
            return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
                ...
                var
                    c, d, e, f, g, h, i, j, k, l, m, n, o, p = this, q = 0, r = p.p.colModel, s = r.length, t = p.grid.headers, u = a("table.ui-jqgrid-htable", p.grid.hDiv), v = u.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"), w = u.children("thead"), x = u.find(".jqg-first-row-header");
                void
                    0 === x[0] ? x = a("<tr>", {
                    role: "row",
                    "aria-hidden": "true"
                ...
                for (a(p).prepend(w), e = a("<tr>", {role: "row"}).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; s > c; c++)if (g = t[c].el, h = a(g), d = r[c], i = {
                        height: "0px",
                        width: t[c].width + "px",
                    ...
                    f = a("<th>").attr({role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction).html(m), n > 0 && f.attr("colspan", String(n)), p.p.headertitles && f.attr("title", f.text()), 0 === n && f.hide(), h.before(f), e.append(g), q = l - 1
                } else
                    0 === q ? b.useColSpanStyle ? h.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction).css({display: d.hidden ? "none" : ""}).insertBefore(h), e.append(g)) : (e.append(g), q--);
    ...
    a.jgrid.extend({
        setTreeNode: function (b, c) {
            return this.each(function () {
                var
                    d = this;
                if (d.grid && d.p.treeGrid)for (var
                                                    e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field, o = d.p.treeReader.leaf_field, p = d.p.treeReader.level_field, q = d.p.treeReader.icon_field, r = d.p.treeReader.loaded; c > b;) {
                    var
                        s, t = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id), u = d.p._index[t];
                    k = d.p.data[u], "nested" === d.p.treeGridModel && (k[o] || (e = parseInt(k[d.p.treeReader.left_field], 10), f = parseInt(k[d.p.treeReader.right_field], 10), k[o] = f === e + 1 ? "true" : "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = k[o])), g = parseInt(k[p], 10), 0 === d.p.tree_root_level ? (h = g + 1, i = g) : (h = g, i = g - 1), j = "<div class='tree-wrap tree-wrap-" + d.p.direction + "' style='width:" + 18 * h + "px;'>", j += "<div style='" + ("rtl" === d.p.direction ? "right:" : "left:") + 18 * i + "px;' class='ui-icon ", void
            ...
            return this.each(function () {
                var
                    b, c, d, e, f = this, g = 0, h = !1, i = [];
                if (f.p.treeGrid) {
                    f.p.treedatatype || a.extend(f.p, {treedatatype: f.p.datatype}), f.p.loadonce && (f.p.treedatatype = "local"), f.p.subGrid = !1, f.p.altRows = !1, f.p.pgbuttons = !1, f.p.pginput = !1, f.p.gridview = !0, null === f.p.rowTotal && (f.p.rowNum = 1e4), f.p.multiselect = !1, f.p.rowList = [], f.p.expColInd = 0, b = "ui-icon-triangle-1-" + ("rtl" === f.p.direction ? "w" : "e"), f.p.treeIcons = a.extend({
                        plus: b,
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        d = a(c).jqGrid("getNodeChildren", b), e = c.p.treeReader.expanded_field;
                    a(d).each(function () {
                        var
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid)switch (d.p.treeGridModel) {
                    ...
                    case"adjacency":
                        var
                            k = d.p.treeReader.parent_id_field, l = d.p.localReader.id;
                        a(this.p.data).each(function () {
            ...
            var
                c = [];
            return this.each(function () {
                if (this.grid && this.p.treeGrid)for (var
                                                          d = a(this).jqGrid("getNodeParent", b); d;)c.push(d), d = a(this).jqGrid("getNodeParent", d)
            }), c
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        var
                            i = a.jgrid.getAccessor(b, this.p.localReader.id), j = a("#" + this.p.idPrefix + a.jgrid.jqID(i), this.grid.bDiv)[0], k = this.p._index[i];
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (b[c]) {
                        b[c] = !1;
                        var
                            d = a.jgrid.getAccessor(b, this.p.localReader.id), e = a("#" + this.p.idPrefix + a.jgrid.jqID(d), this.grid.bDiv)[0];
    ...
    a.assocArraySize = function (a) {
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                ...
                m(a, b) {
                    ...
                    for (c
                        in
                        a) {
                        if (a.hasOwnProperty(c) && a[c] != this[d]) {
                            e = !1;
                            break
                        }
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, j = 0; k > j; j++) {
                        var
                            p, q = [];
                        for (f = 0; l > f; f++) {
                            if (null == d)g = a.trim(c[f].member) + "_" + c[f].aggregator, p = g, o[0] = p; else {
                                p = d[j].replace(/\s+/g, "");
                                try {
                            ...
                            g = isNaN(parseInt(g, 10)) ? g : g + " ", e[g] = q[g] = n(c[f].aggregator, e[g], c[f].member, b), 1 >= j && "_r_Totals" !== p && "" === m && (m = p)
                        }
                        h[g] = q, i[g] = o[j]
                    }
                    return e
                ...
                p(a) {
                    ...
                    for (d
                        ...
                        if ("object" != typeof
                            ...
                            if ("level" === d) {
                                if (void
                                        0 === L[a.level] && (L[a.level] = "", a.level > 0 && "_r_Totals" !== a.text && (k[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                                    })), L[a.level] !== a.text && a.children.length && "_r_Totals" !== a.text && a.level > 0) {
                                    k[a.level - 1].groupHeaders.push({titleText: a.label, numberOfColumns: 0});
                                    var
                                        h = k[a.level - 1].groupHeaders.length - 1, i = 0 === h ? N : M + v;
                                    if (a.level - 1 === (l.rowTotals ? 1 : 0) && h > 0) {
                                        var
                                            j = k[a.level - 1].groupHeaders[h - 1].numberOfColumns;
                                        j && (i = j + 1 + l.aggregates.length)
                                    }
                                    k[a.level - 1].groupHeaders[h].startColumnName = e[i].name, k[a.level - 1].groupHeaders[h].numberOfColumns = e.length - i, M = e.length
                                }
                                L[a.level] = a.text
                            }
                            if (a.level === u && "level" === d && u > 0)if (v > 1) {
                                ...
                                for (b
                                    in
                                    a.fields)a.fields.hasOwnProperty(b) && 1 === m && k[u - 1].groupHeaders.push({
                                    startColumnName: b,
                                    numberOfColumns: 1,
                                    titleText: a.text
                                }), m++;
                                k[u - 1].groupHeaders[k[u - 1].groupHeaders.length - 1].numberOfColumns = m - 1
                            } else
                                k.splice(u - 1, 1)
                        }
                        if (null != a[d] && "object" == typeof
                                a[d] && p(a[d]), "level" === d && a.level > 0) {
                            c = 0;
                            for (b
                                in
            ...
            return this.each(function () {
                ...
                f(b) {
                    var
                        e, f = jQuery(g).jqGrid("pivotSetup", b, c), h = a.assocArraySize(f.summary) > 0 ? !0 : !1, i = a.jgrid.from.call(g, f.rows);
...
!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.extend(a.jgrid, {
        saveState: function (b, c) {
            ...
            if (d = a.extend({
                ...
                if (c) {
                    ...
                    if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
                        ...
                        e.shrinkToFit = !1, e.data = [], e.datatype = "local", e.grouping = !1, e.navGrid = !1, e.inlineNav && (h = l(e._iN), e._iN = null, delete
                            e._iN), e.filterToolbar && (i = l(e._fT), e._fT = null, delete
                            e._fT);
                        var
                            n = a("#" + b).jqGrid(e);
                        n.append(g), n.jqGrid("setGridParam", m), e.storeNavOptions && n.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.inlineNav && h && (n.jqGrid("setGridParam", {inlineNav: !1}), n.jqGrid("inlineNav", e.pager, h)), e.filterToolbar && i && (n.jqGrid("setGridParam", {filterToolbar: !1}), n.jqGrid("filterToolbar", i)), n[0].updatepager(!0, !0), d.clearAfterLoad && (window[d.storageType].removeItem("jqGrid" + j.id), window[d.storageType].removeItem("jqGrid" + j.id + "_data"))
                    } else
                        alert("can not convert to object")
                }
            }
        }, setRegional: function (b, c) {
            a.jgrid.saveState(b, {storageType: "sessionStorage"}), a.jgrid.loadState(b, null, {
            ...
            var
                d = a("#" + b)[0], e = a(d).jqGrid("getGridParam", "colModel"), f = -1, g = a.jgrid.getRegional(d, "nav");
            a.each(e, function (a) {
                return this.formatter && "actions" === this.formatter ? (f = a, !1) : void
                    0
        ...
        jqGridExport: function (b) {
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        d, e = a.extend(!0, {}, a(this).jqGrid("getGridParam"), b.addOptions);
                    if (e.rownumbers && (e.colNames.splice(0, 1), e.colModel.splice(0, 1)), e.multiselect && (e.colNames.splice(0, 1), e.colModel.splice(0, 1)), e.subGrid && (e.colNames.splice(0, 1), e.colModel.splice(0, 1)), e.knv = null, e.treeGrid)for (d
                        in
                        e.treeReader)e.treeReader.hasOwnProperty(d) && (e.colNames.splice(e.colNames.length - 1), e.colModel.splice(e.colModel.length - 1));
                    switch (b.exptype) {
                        case"xmlstring":
    ...
    return window.jqGridUtils = {
        stringify: function (a) {
            ...
            return JSON.parse(str, function (key, value) {
                return "string" == typeof
                    value && -1 !== value.indexOf("function") ? eval("(" + value + ")") : value
            })
        }, encode: function (a) {
            ...
            var
                c = $.extend({
                    ...
                    for (var
                        ...
                        var
                            k = b[j];
                        j.charAt(0) !== c.attr_prefix ? h[h.length] = null == k ? "<" + j + " />" : "object" == typeof
                        ...
                        apply_perm: function () {
                            ...
                            $("option", e).each(function () {
                                ...
                                var
                                    a = parseInt(this, 10);
                                c = b(c, a, a)
                            }), a.done && a.done.call(k, c), k.jqGrid("setGridWidth", k[0].p.tblwidth, k[0].p.shrinkToFit)
                        },
                        cleanup: function (b) {
