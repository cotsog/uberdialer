...
var _idleTimeout = 120000;//3000;       // 30 seconds //120000
var _awayTimeout = 900000;//600000;      // 10 minutes //900000
...
function _active(event)
{
    ...
    setCookie('event_idle_time_stamp',t);
    if (_idleNow) {
...
document.onBack=function(a,b){
	if(a){
        ...
        tId = setInterval(heartBeatAjaxCall, set_heart_beat_interval );		
	}
	if(b){
