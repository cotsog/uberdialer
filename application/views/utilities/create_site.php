...
<section class="section-content-main-area">
    <div class="content-main-area">
        ...
        echo form_open('/utilities/createsite/', $attributes);
        ?>
        ...
        <div class="form-row">
            <div class="dialog-form">
                ...
                <div class="form-input"><input type="text" id="name" name="name" placeholder="Name" required value=""/>
                        ...
                        <select name="siteId" id="siteId">
                            ...
                            if (!empty($siteIds)) {
                                foreach ($siteIds as $site) {
                                    ...
                                    <option role="option" value="<?= $siteId;?>"><?= $siteName;?></option>
                                <?php }
                            }
                            ?>
                        </select>
